...
class EquipmentPsu(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("EquipmentPsu", "equipmentPsu", "psu-[id]", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'computeServerNode', u'equipmentChassis'], [u'faultInst'], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "fw_version": MoPropertyMeta("fw_version", "fwVersion", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version151f, MoPropertyMeta.NAMING, None, None, None, None, [], ["1-4"]), 
            "input": MoPropertyMeta("input", "input", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "max_output": MoPropertyMeta("max_output", "maxOutput", "string", VersionMeta.Version201a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            ...
            "pid": MoPropertyMeta("pid", "pid", "string", VersionMeta.Version301c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "modular": {
            ...
            "id": MoPropertyMeta("id", "id", "uint", VersionMeta.Version2013e, MoPropertyMeta.NAMING, None, None, None, None, [], ["1-4"]), 
            "input": MoPropertyMeta("input", "input", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "max_output": MoPropertyMeta("max_output", "maxOutput", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
