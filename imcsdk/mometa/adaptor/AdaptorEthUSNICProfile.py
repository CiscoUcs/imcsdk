...
class AdaptorEthUSNICProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorEthUSNICProfile", "adaptorEthUSNICProfile", "ethusnic", VersionMeta.Version151x, "InputOutput", 0x3ffff, [], ["admin"], [u'adaptorHostEthIf'], [], ["Get", "Remove", "Set"])
    ...
    prop_meta = {
        ...
        "receive_queue_ring_size": MoPropertyMeta("receive_queue_ring_size", "receiveQueueRingSize", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, [], ["64-4096"]), 
        ...
        "transmit_queue_ring_size": MoPropertyMeta("transmit_queue_ring_size", "transmitQueueRingSize", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x10000, None, None, None, [], ["64-4096"]), 
