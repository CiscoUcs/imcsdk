...
class NamingId:
    ...
    ADAPTOR_ETH_SRIOVPROFILE = "adaptorEthSRIOVProfile"
    ...
    BIOS_VF_ACPI_SRAT_SP_FLAG_EN = "biosVfAcpiSratSpFlagEn"
    BIOS_VF_ADAPTIVE_REFRESH_MGMT_LEVEL = "biosVfAdaptiveRefreshMgmtLevel"
    ...
    BIOS_VF_CBS_CMN_APBDIS_DF_PSTATE_RS = "biosVfCbsCmnApbdisDfPstateRs"
    BIOS_VF_CBS_CMN_CPU_AVX512 = "biosVfCbsCmnCpuAvx512"
    ...
    BIOS_VF_CBS_CMN_CPU_SEV_ASID_SPACE_LIMIT = "biosVfCbsCmnCpuSevAsidSpaceLimit"
    ...
    BIOS_VF_CBS_CMN_EDC_CONTROL_THROTTLE = "biosVfCbsCmnEdcControlThrottle"
    BIOS_VF_CBS_CMN_EFFICIENCY_MODE_EN = "biosVfCbsCmnEfficiencyModeEn"
    BIOS_VF_CBS_CMN_EFFICIENCY_MODE_EN_RS = "biosVfCbsCmnEfficiencyModeEnRs"
    ...
    BIOS_VF_CBS_CMN_GNB_SMUDFFO_RS = "biosVfCbsCmnGnbSMUDffoRs"
    BIOS_VF_CBS_CMN_GNB_SMUDLWM_SUPPORT = "biosVfCbsCmnGnbSMUDlwmSupport"
    ...
    BIOS_VF_CBS_CMN_MEM_SPEED_DDR47XX2 = "biosVfCbsCmnMemSpeedDdr47xx2"
    BIOS_VF_CBS_CMN_MEM_SPEED_DDR47XX3 = "biosVfCbsCmnMemSpeedDdr47xx3"
    BIOS_VF_CBS_CMN_PREFERRED_IO7XX2 = "biosVfCbsCmnPreferredIO7xx2"
    BIOS_VF_CBS_CMN_PREFERRED_IO7XX3 = "biosVfCbsCmnPreferredIO7xx3"
    BIOS_VF_CBS_CMNC_TDPCTL = "biosVfCbsCmncTDPCtl"
    BIOS_VF_CBS_CMNX_GMI_FORCE_LINK_WIDTH_RS = "biosVfCbsCmnxGmiForceLinkWidthRs"
    BIOS_VF_CBS_CPU_CCD_CTRL_SSP = "biosVfCbsCpuCcdCtrlSsp"
    BIOS_VF_CBS_CPU_CORE_CTRL = "biosVfCbsCpuCoreCtrl"
    BIOS_VF_CBS_CPU_DOWN_CORE_CTRL_BERGAMO = "biosVfCbsCpuDownCoreCtrlBergamo"
    BIOS_VF_CBS_CPU_DOWN_CORE_CTRL_GENOA = "biosVfCbsCpuDownCoreCtrlGenoa"
    BIOS_VF_CBS_CPU_SMT_CTRL = "biosVfCbsCpuSmtCtrl"
    BIOS_VF_CBS_DBG_CPU_GEN_CPU_WDT = "biosVfCbsDbgCpuGenCpuWdt"
    BIOS_VF_CBS_DBG_CPU_LAPIC_MODE = "biosVfCbsDbgCpuLApicMode"
    ...
    BIOS_VF_CBS_DF_CMN4_LINK_MAX_XGMI_SPEED = "biosVfCbsDfCmn4LinkMaxXgmiSpeed"
    BIOS_VF_CBS_DF_CMN_ACPI_SRAT_L3_NUMA = "biosVfCbsDfCmnAcpiSratL3Numa"
    BIOS_VF_CBS_DF_CMN_DRAM_NPS = "biosVfCbsDfCmnDramNps"
    BIOS_VF_CBS_DF_CMN_DRAM_SCRUB_TIME = "biosVfCbsDfCmnDramScrubTime"
    BIOS_VF_CBS_DF_CMN_MEM_INTLV = "biosVfCbsDfCmnMemIntlv"
    BIOS_VF_CBS_DF_CMN_MEM_INTLV_CONTROL = "biosVfCbsDfCmnMemIntlvControl"
    BIOS_VF_CBS_DF_CMN_MEM_INTLV_SIZE = "biosVfCbsDfCmnMemIntlvSize"
    BIOS_VF_CBS_DF_DBG_XGMI_LINK_CFG = "biosVfCbsDfDbgXgmiLinkCfg"
    BIOS_VF_CBS_GNB_DBG_PCIE_TBT_SUPPORT = "biosVfCbsGnbDbgPcieTbtSupport"
    ...
    BIOS_VF_DFX_OSB_EN = "biosVfDfxOsbEn"
    ...
    BIOS_VF_ENABLE_RMT = "biosVfEnableRMT"
    BIOS_VF_ENABLE_TDX = "biosVfEnableTdx"
    BIOS_VF_ENABLE_TDX_SEAMLDR = "biosVfEnableTdxSeamldr"
    ...
    BIOS_VF_ERROR_CHECK_SCRUB = "biosVfErrorCheckScrub"
    ...
    BIOS_VF_IOATCONFIG_CPM = "biosVfIOATConfigCpm"
    ...
    BIOS_VF_LATENCY_OPTIMIZED_MODE = "biosVfLatencyOptimizedMode"
    ...
    BIOS_VF_MMIOH_BASE = "biosVfMmiohBase"
    BIOS_VF_MMIOH_SIZE = "biosVfMmiohSize"
    ...
    BIOS_VF_OPTIMIZED_POWER_MODE = "biosVfOptimizedPowerMode"
    ...
    BIOS_VF_PCH_PCIE_PLL_SSC = "biosVfPchPciePllSsc"
    ...
    BIOS_VF_PRMRR_SIZE = "biosVfPrmrrSize"
    ...
    BIOS_VF_RESIZE_BAR_SUPPORT = "biosVfResizeBarSupport"
    BIOS_VF_RESUME_ON_ACPOWER_LOSS = "biosVfResumeOnACPowerLoss"
    BIOS_VF_RUNTIME_POST_PACKAGE_REPAIR = "biosVfRuntimePostPackageRepair"
    BIOS_VF_SEV = "biosVfSEV"
    BIOS_VF_SHA1_PCRBANK = "biosVfSHA1PCRBank"
    BIOS_VF_SHA256_PCRBANK = "biosVfSHA256PCRBank"
    BIOS_VF_SHA384_PCRBANK = "biosVfSHA384PCRBank"
    ...
    BIOS_VF_SERIAL_MUX = "biosVfSerialMux"
    ...
    BIOS_VF_TPM_SUPPORT = "biosVfTpmSupport"
    ...
    BIOS_VF_UEFI_MEM_MAP_SP_FLAG_EN = "biosVfUefiMemMapSpFlagEn"
    ...
    NIOS_INSTALL = "niosInstall"
    NOT_FILTER = "notFilter"
    NVME_HYBRID_SLOT_CONFIG = "nvmeHybridSlotConfig"
    ...
    PACKAGE_POWER_LIMIT = "packagePowerLimit"
    PAIR = "pair"
    PCI_ADAPTER_FRU_INVENTORY = "pciAdapterFruInventory"
    PCI_ADAPTER_FRU_INVENTORY_INFO = "pciAdapterFruInventoryInfo"
    PCI_ADAPTER_PORT_STATUS = "pciAdapterPortStatus"
    PCI_ADAPTER_TEMPERATURE = "pciAdapterTemperature"
...
class NamingPropertyId:
    ...
    F2_PASSWORDOPT_IN = "f2PasswordoptIn"
    ...
    IO_PERF_MODE_ENABLED = "ioPerfModeEnabled"
    ...
    NEW_BIOS_PASSWORD = "newBiosPassword"
    ...
    OLD_BIOS_PASSWORD = "oldBiosPassword"
    ONLINE = "online"
    ...
    SAS_ADDRESS_C = "sasAddressC"
    SAS_EXPANDER = "sasExpander"
    SATA_NVME = "sataNVMe"
    SCU_BOOT_MEDIUM = "scuBootMedium"
    ...
    SRIOV_COMPLETION_COUNT = "sriovCompletionCount"
    SRIOV_INTERRUPT_COUNT = "sriovInterruptCount"
    SRIOV_RECEIVE_COUNT = "sriovReceiveCount"
    SRIOV_TRANSMIT_COUNT = "sriovTransmitCount"
    SSH_KEY = "sshKey"
    ...
    TRANSMIT_ENHANCED_MODE = "transmitEnhancedMode"
    ...
    VERSION = "version"
    VHBA_TYPE = "vhbaType"
    VIC_COMMUNICABLE = "vicCommunicable"
    ...
    VP_ACPI_SRAT_SP_FLAG_EN = "vpAcpiSratSpFlagEn"
    VP_ADAPTIVE_REFRESH_MGMT_LEVEL = "vpAdaptiveRefreshMgmtLevel"
    ...
    VP_CBS_CMN_APBDIS_DF_PSTATE_RS = "vpCbsCmnApbdisDfPstateRs"
    VP_CBS_CMN_CPU_AVX512 = "vpCbsCmnCpuAvx512"
    ...
    VP_CBS_CMN_CPU_SEV_ASID_SPACE_LIMIT = "vpCbsCmnCpuSevAsidSpaceLimit"
    ...
    VP_CBS_CMN_EDC_CONTROL_THROTTLE = "vpCbsCmnEdcControlThrottle"
    ...
    VP_CBS_CMN_GNB_SMUDFFO_RS = "vpCbsCmnGnbSMUDffoRs"
    VP_CBS_CMN_GNB_SMUDLWM_SUPPORT = "vpCbsCmnGnbSMUDlwmSupport"
    VP_CBS_CMN_MEM_CTRL_BANK_GROUP_SWAP_DDR4 = "vpCbsCmnMemCtrlBankGroupSwapDdr4"
    VP_CBS_CMN_MEM_CTRLLER_PWR_DN_EN_DDR = "vpCbsCmnMemCtrllerPwrDnEnDdr"
    VP_CBS_CMN_MEM_MAP_BANK_INTERLEAVE_DDR4 = "vpCbsCmnMemMapBankInterleaveDdr4"
    VP_CBS_CMN_MEM_SPEED_DDR47XX2 = "vpCbsCmnMemSpeedDdr47xx2"
    VP_CBS_CMN_MEM_SPEED_DDR47XX3 = "vpCbsCmnMemSpeedDdr47xx3"
    VP_CBS_CMN_PREFERRED_IO7XX2 = "vpCbsCmnPreferredIO7xx2"
    VP_CBS_CMN_PREFERRED_IO7XX3 = "vpCbsCmnPreferredIO7xx3"
    VP_CBS_CMNC_TDPCTL = "vpCbsCmncTDPCtl"
    VP_CBS_CMNX_GMI_FORCE_LINK_WIDTH_RS = "vpCbsCmnxGmiForceLinkWidthRs"
    VP_CBS_CPU_CCD_CTRL_SSP = "vpCbsCpuCcdCtrlSsp"
    VP_CBS_CPU_CORE_CTRL = "vpCbsCpuCoreCtrl"
    VP_CBS_CPU_DOWN_CORE_CTRL_BERGAMO = "vpCbsCpuDownCoreCtrlBergamo"
    VP_CBS_CPU_DOWN_CORE_CTRL_GENOA = "vpCbsCpuDownCoreCtrlGenoa"
    VP_CBS_CPU_SMT_CTRL = "vpCbsCpuSmtCtrl"
    VP_CBS_DBG_CPU_GEN_CPU_WDT = "vpCbsDbgCpuGenCpuWdt"
    VP_CBS_DBG_CPU_LAPIC_MODE = "vpCbsDbgCpuLApicMode"
    VP_CBS_DBG_CPU_SNP_MEM_COVER = "vpCbsDbgCpuSnpMemCover"
    VP_CBS_DBG_CPU_SNP_MEM_SIZE_COVER = "vpCbsDbgCpuSnpMemSizeCover"
    VP_CBS_DF_CMN4_LINK_MAX_XGMI_SPEED = "vpCbsDfCmn4LinkMaxXgmiSpeed"
    VP_CBS_DF_CMN_ACPI_SRAT_L3_NUMA = "vpCbsDfCmnAcpiSratL3Numa"
    VP_CBS_DF_CMN_DRAM_NPS = "vpCbsDfCmnDramNps"
    VP_CBS_DF_CMN_DRAM_SCRUB_TIME = "vpCbsDfCmnDramScrubTime"
    ...
    VP_CBS_DF_DBG_XGMI_LINK_CFG = "vpCbsDfDbgXgmiLinkCfg"
    ...
    VP_DFX_OSB_EN = "vpDfxOsbEn"
    VP_DIRECT_CACHE_ACCESS = "vpDirectCacheAccess"
    VP_DMA_CTRL_OPT_IN = "vpDmaCtrlOptIn"
    ...
    VP_ENABLE_RMT = "vpEnableRMT"
    VP_ENABLE_SGX = "vpEnableSgx"
    VP_ENABLE_TDX = "vpEnableTdx"
    VP_ENABLE_TDX_SEAMLDR = "vpEnableTdxSeamldr"
    ...
    VP_ERROR_CHECK_SCRUB = "vpErrorCheckScrub"
    ...
    VP_IOATCONFIG_CPM = "vpIOATConfigCpm"
    ...
    VP_LATENCY_OPTIMIZED_MODE = "vpLatencyOptimizedMode"
    ...
    VP_MMIOH_BASE = "vpMmiohBase"
    VP_MMIOH_SIZE = "vpMmiohSize"
    ...
    VP_OPTIMIZED_POWER_MODE = "vpOptimizedPowerMode"
    ...
    VP_PCH_PCIE_PLL_SSC = "vpPchPciePllSsc"
    ...
    VP_RESIZE_BAR_SUPPORT = "vpResizeBarSupport"
    VP_RESUME_ON_ACPOWER_LOSS = "vpResumeOnACPowerLoss"
    VP_RUNTIME_POST_PACKAGE_REPAIR = "vpRuntimePostPackageRepair"
    VP_SEV = "vpSEV"
    VP_SHA1_PCRBANK = "vpSHA1PCRBank"
    VP_SHA256_PCRBANK = "vpSHA256PCRBank"
    VP_SHA384_PCRBANK = "vpSHA384PCRBank"
    VP_SMEE = "vpSMEE"
    VP_SNC = "vpSNC"
    ...
    VP_SLOT_FRONT_NVME13_LINK_SPEED = "vpSlotFrontNvme13LinkSpeed"
    VP_SLOT_FRONT_NVME13_OPTION_ROM = "vpSlotFrontNvme13OptionROM"
    VP_SLOT_FRONT_NVME14_LINK_SPEED = "vpSlotFrontNvme14LinkSpeed"
    VP_SLOT_FRONT_NVME14_OPTION_ROM = "vpSlotFrontNvme14OptionROM"
    VP_SLOT_FRONT_NVME15_LINK_SPEED = "vpSlotFrontNvme15LinkSpeed"
    ...
    VP_SLOT_FRONT_NVME17_LINK_SPEED = "vpSlotFrontNvme17LinkSpeed"
    VP_SLOT_FRONT_NVME17_OPTION_ROM = "vpSlotFrontNvme17OptionROM"
    VP_SLOT_FRONT_NVME18_LINK_SPEED = "vpSlotFrontNvme18LinkSpeed"
    VP_SLOT_FRONT_NVME18_OPTION_ROM = "vpSlotFrontNvme18OptionROM"
    VP_SLOT_FRONT_NVME19_LINK_SPEED = "vpSlotFrontNvme19LinkSpeed"
    ...
    VP_SLOT_FRONT_NVME20_LINK_SPEED = "vpSlotFrontNvme20LinkSpeed"
    VP_SLOT_FRONT_NVME20_OPTION_ROM = "vpSlotFrontNvme20OptionROM"
    VP_SLOT_FRONT_NVME21_LINK_SPEED = "vpSlotFrontNvme21LinkSpeed"
    VP_SLOT_FRONT_NVME21_OPTION_ROM = "vpSlotFrontNvme21OptionROM"
    VP_SLOT_FRONT_NVME22_LINK_SPEED = "vpSlotFrontNvme22LinkSpeed"
    VP_SLOT_FRONT_NVME22_OPTION_ROM = "vpSlotFrontNvme22OptionROM"
    VP_SLOT_FRONT_NVME23_LINK_SPEED = "vpSlotFrontNvme23LinkSpeed"
    VP_SLOT_FRONT_NVME23_OPTION_ROM = "vpSlotFrontNvme23OptionROM"
    VP_SLOT_FRONT_NVME24_LINK_SPEED = "vpSlotFrontNvme24LinkSpeed"
    VP_SLOT_FRONT_NVME24_OPTION_ROM = "vpSlotFrontNvme24OptionROM"
    VP_SLOT_FRONT_NVME25_LINK_SPEED = "vpSlotFrontNvme25LinkSpeed"
    VP_SLOT_FRONT_NVME25_OPTION_ROM = "vpSlotFrontNvme25OptionROM"
    VP_SLOT_FRONT_NVME26_LINK_SPEED = "vpSlotFrontNvme26LinkSpeed"
    VP_SLOT_FRONT_NVME26_OPTION_ROM = "vpSlotFrontNvme26OptionROM"
    VP_SLOT_FRONT_NVME27_LINK_SPEED = "vpSlotFrontNvme27LinkSpeed"
    VP_SLOT_FRONT_NVME27_OPTION_ROM = "vpSlotFrontNvme27OptionROM"
    VP_SLOT_FRONT_NVME28_LINK_SPEED = "vpSlotFrontNvme28LinkSpeed"
    VP_SLOT_FRONT_NVME28_OPTION_ROM = "vpSlotFrontNvme28OptionROM"
    VP_SLOT_FRONT_NVME29_LINK_SPEED = "vpSlotFrontNvme29LinkSpeed"
    VP_SLOT_FRONT_NVME29_OPTION_ROM = "vpSlotFrontNvme29OptionROM"
    VP_SLOT_FRONT_NVME2_LINK_SPEED = "vpSlotFrontNvme2LinkSpeed"
    VP_SLOT_FRONT_NVME2_OPTION_ROM = "vpSlotFrontNvme2OptionROM"
    VP_SLOT_FRONT_NVME30_LINK_SPEED = "vpSlotFrontNvme30LinkSpeed"
    VP_SLOT_FRONT_NVME30_OPTION_ROM = "vpSlotFrontNvme30OptionROM"
    VP_SLOT_FRONT_NVME31_LINK_SPEED = "vpSlotFrontNvme31LinkSpeed"
    VP_SLOT_FRONT_NVME31_OPTION_ROM = "vpSlotFrontNvme31OptionROM"
    VP_SLOT_FRONT_NVME32_LINK_SPEED = "vpSlotFrontNvme32LinkSpeed"
    VP_SLOT_FRONT_NVME32_OPTION_ROM = "vpSlotFrontNvme32OptionROM"
    ...
    VP_UEFI_MEM_MAP_SP_FLAG_EN = "vpUefiMemMapSpFlagEn"
    ...
    VP_X2_APIC_OPT_OUT = "vpX2ApicOptOut"
