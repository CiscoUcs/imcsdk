"""This module contains the general information for ExportClientPrivateKey ManagedObject."""
...
class ExportClientPrivateKeyConsts:
    PROTOCOL_FTP = "ftp"
    PROTOCOL_HTTP = "http"
    PROTOCOL_NONE = "none"
    PROTOCOL_SCP = "scp"
...
class ExportClientPrivateKey(ManagedObject):
    """This is ExportClientPrivateKey class."""

    consts = ExportClientPrivateKeyConsts()
    naming_props = set([])

    mo_meta = {
        "classic": MoMeta("ExportClientPrivateKey", "exportClientPrivateKey", "kmip-private-key-export", VersionMeta.Version302b, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None]),
        "modular": MoMeta("ExportClientPrivateKey", "exportClientPrivateKey", "kmip-private-key-export", VersionMeta.Version303a, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None])
    }
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExportClientPrivateKey", parent_mo_or_dn, **kwargs)
