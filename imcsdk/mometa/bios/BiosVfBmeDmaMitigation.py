...
class BiosVfBmeDmaMitigation(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfBmeDmaMitigation", "biosVfBmeDmaMitigation", "bme-dma-mitigation", VersionMeta.Version401a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
