...
class VersionMeta:
    ...
    Version304j = ImcVersion("3.0(4j)")
    Version311d = ImcVersion("3.1(1d)")
    Version312b = ImcVersion("3.1(2b)")
    Version312i = ImcVersion("3.1(2i)")
    Version313a = ImcVersion("3.1(3a)")
    Version401a = ImcVersion("4.0(1a)")
    Version401c = ImcVersion("4.0(1c)")
...
MO_CLASS_META = {
    "classic": {
        ...
        "AdaptorEthMultiQueueProfile": MoMeta("AdaptorEthMultiQueueProfile", "adaptorEthMultiQueueProfile", "eth-multi-q", VersionMeta.Version402c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'adaptorHostEthIf'], [], [None]),
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "BiosVfAutoCCState": MoMeta("BiosVfAutoCCState", "biosVfAutoCCState", "auto-cc-state", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfBmeDmaMitigation": MoMeta("BiosVfBmeDmaMitigation", "biosVfBmeDmaMitigation", "bme-dma-mitigation", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfBootOptionNumRetry": MoMeta("BiosVfBootOptionNumRetry", "biosVfBootOptionNumRetry", "Boot-option-num-retry", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfBootOptionReCoolDown": MoMeta("BiosVfBootOptionReCoolDown", "biosVfBootOptionReCoolDown", "Boot-option-cool-down-retry", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfCbsCmnCpuCpb": MoMeta("BiosVfCbsCmnCpuCpb", "biosVfCbsCmnCpuCpb", "cpu-cpb", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnCpuGenDowncoreCtrl": MoMeta("BiosVfCbsCmnCpuGenDowncoreCtrl", "biosVfCbsCmnCpuGenDowncoreCtrl", "downcore-ctrl", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnCpuGlobalCstateCtrl": MoMeta("BiosVfCbsCmnCpuGlobalCstateCtrl", "biosVfCbsCmnCpuGlobalCstateCtrl", "cpu-cstate", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnCpuL1StreamHwPrefetcher": MoMeta("BiosVfCbsCmnCpuL1StreamHwPrefetcher", "biosVfCbsCmnCpuL1StreamHwPrefetcher", "cpu-l1-prefetch", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnCpuL2StreamHwPrefetcher": MoMeta("BiosVfCbsCmnCpuL2StreamHwPrefetcher", "biosVfCbsCmnCpuL2StreamHwPrefetcher", "cpu-l2-prefetch", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnDeterminismSlider": MoMeta("BiosVfCbsCmnDeterminismSlider", "biosVfCbsCmnDeterminismSlider", "cpu-detslider", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnGnbNbIOMMU": MoMeta("BiosVfCbsCmnGnbNbIOMMU", "biosVfCbsCmnGnbNbIOMMU", "io-mmu", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnMemCtrlBankGroupSwapDdr4": MoMeta("BiosVfCbsCmnMemCtrlBankGroupSwapDdr4", "biosVfCbsCmnMemCtrlBankGroupSwapDdr4", "bank-groupswap", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmnMemMapBankInterleaveDdr4": MoMeta("BiosVfCbsCmnMemMapBankInterleaveDdr4", "biosVfCbsCmnMemMapBankInterleaveDdr4", "chipset-interleave", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsCmncTDPCtl": MoMeta("BiosVfCbsCmncTDPCtl", "biosVfCbsCmncTDPCtl", "ctdp-control", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsDfCmnMemIntlv": MoMeta("BiosVfCbsDfCmnMemIntlv", "biosVfCbsDfCmnMemIntlv", "mem-interleave", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCbsDfCmnMemIntlvSize": MoMeta("BiosVfCbsDfCmnMemIntlvSize", "biosVfCbsDfCmnMemIntlvSize", "mem-size-interleave", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCiscoAdaptiveMemTraining": MoMeta("BiosVfCiscoAdaptiveMemTraining", "biosVfCiscoAdaptiveMemTraining", "Cisco-Adap-Mem", VersionMeta.Version402c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCiscoDebugLevel": MoMeta("BiosVfCiscoDebugLevel", "biosVfCiscoDebugLevel", "Cisco-Debug-Level", VersionMeta.Version402c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfCiscoOpromLaunchOptimization": MoMeta("BiosVfCiscoOpromLaunchOptimization", "biosVfCiscoOpromLaunchOptimization", "Cisco-Opromlaunch-Optimize", VersionMeta.Version402c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfDCPMMFirmwareDowngrade": MoMeta("BiosVfDCPMMFirmwareDowngrade", "biosVfDCPMMFirmwareDowngrade", "DCPMM-Firmware-Downgrade", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfEPPProfile": MoMeta("BiosVfEPPProfile", "biosVfEPPProfile", "epp-profile", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfEnergyEfficientTurbo": MoMeta("BiosVfEnergyEfficientTurbo", "biosVfEnergyEfficientTurbo", "energy-efficient-turbo", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfIMCInterleave": MoMeta("BiosVfIMCInterleave", "biosVfIMCInterleave", "imc-interleave", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIPV6PXE": MoMeta("BiosVfIPV6PXE", "biosVfIPV6PXE", "IPv6-Pxe", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIntelSpeedSelect": MoMeta("BiosVfIntelSpeedSelect", "biosVfIntelSpeedSelect", "Intel-Speed-Select", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfKTIPrefetch": MoMeta("BiosVfKTIPrefetch", "biosVfKTIPrefetch", "kti-prefetch", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfLLCPrefetch": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfPSata": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfSMEE": MoMeta("BiosVfSMEE", "biosVfSMEE", "smee", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfSmtMode": MoMeta("BiosVfSmtMode", "biosVfSmtMode", "smt-mode", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfSubNumaClustering": MoMeta("BiosVfSubNumaClustering", "biosVfSubNumaClustering", "sub-numa-cluster", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfSvmMode": MoMeta("BiosVfSvmMode", "biosVfSvmMode", "svm-mode", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfTPMControl": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfTXTSupport": MoMeta("BiosVfTXTSupport", "biosVfTXTSupport", "TXT-Support", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfVMDEnable": MoMeta("BiosVfVMDEnable", "biosVfVMDEnable", "VMDEnable", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfXPTPrefetch": MoMeta("BiosVfXPTPrefetch", "biosVfXPTPrefetch", "xpt-prefetch", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "CloudDeviceConnectorEp": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["read-only"], [u'cloudMgmtSvc'], [u'faultInst', u'mgmtController'], [None]),
        "CloudMgmtSvc": MoMeta("CloudMgmtSvc", "cloudMgmtSvc", "cloud-mgmt", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["read-only"], [u'topSystem'], [u'cloudDeviceConnectorEp'], [None]),
        ...
        "CommSnmp": MoMeta("CommSnmp", "commSnmp", "snmp-svc", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commSvcEp'], [u'commSnmpConfigCommit', u'commSnmpTrap', u'commSnmpUser'], ["Get", "Set"]),
        "CommSnmpConfigCommit": MoMeta("CommSnmpConfigCommit", "commSnmpConfigCommit", "snmp-config-commit", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commSnmp'], [], [None]),
        ...
        "EquipmentRackEnclosure": MoMeta("EquipmentRackEnclosure", "equipmentRackEnclosure", "sys/rack-enclosure-1", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'topSystem'], [], [None]),
        ...
        "GenerateRandomPassword": MoMeta("GenerateRandomPassword", "generateRandomPassword", "generate-random-pwd", VersionMeta.Version301c, "OutputOnly", 0x1, [], ["admin", "user"], [u'aaaUserEp'], [], ["Get"]),
        ...
        "GraphicsCard": MoMeta("GraphicsCard", "graphicsCard", "graphics-card-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["read-only"], [u'computeBoard'], [], [None]),
        ...
        "LsbootCdd": MoMeta("LsbootCdd", "lsbootCdd", "cdd-[name]", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'lsbootDevPrecision'], [], ["Get", "Set"]),
        ...
        "MemoryArray": MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'faultInst', u'memoryPersistentMemoryUnit', u'memoryUnit'], ["Get", "Set"]),
        "MemoryPersistentMemoryBackup": MoMeta("MemoryPersistentMemoryBackup", "memoryPersistentMemoryBackup", "export-config", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [], [None]),
        "MemoryPersistentMemoryConfigResult": MoMeta("MemoryPersistentMemoryConfigResult", "memoryPersistentMemoryConfigResult", "cfg-result", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [u'memoryPersistentMemoryNamespaceConfigResult'], [None]),
        "MemoryPersistentMemoryConfiguration": MoMeta("MemoryPersistentMemoryConfiguration", "memoryPersistentMemoryConfiguration", "pmemory-config", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'memoryPersistentMemoryBackup', u'memoryPersistentMemoryConfigResult', u'memoryPersistentMemoryImporter', u'memoryPersistentMemoryRegion'], [None]),
        "MemoryPersistentMemoryDimms": MoMeta("MemoryPersistentMemoryDimms", "memoryPersistentMemoryDimms", "pmemory-dimms-[socket_id]", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryLogicalConfiguration'], [], [None]),
        "MemoryPersistentMemoryGoal": MoMeta("MemoryPersistentMemoryGoal", "memoryPersistentMemoryGoal", "goal-[socket_id]", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryLogicalConfiguration'], [], [None]),
        "MemoryPersistentMemoryImporter": MoMeta("MemoryPersistentMemoryImporter", "memoryPersistentMemoryImporter", "import-config", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [], [None]),
        "MemoryPersistentMemoryLocalSecurity": MoMeta("MemoryPersistentMemoryLocalSecurity", "memoryPersistentMemoryLocalSecurity", "local", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemorySecurity'], [], [None]),
        ...
        "MemoryPersistentMemoryLogicalNamespace": MoMeta("MemoryPersistentMemoryLogicalNamespace", "memoryPersistentMemoryLogicalNamespace", "lns-[name]", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryLogicalConfiguration'], [], [None]),
        "MemoryPersistentMemoryNamespace": MoMeta("MemoryPersistentMemoryNamespace", "memoryPersistentMemoryNamespace", "ns-[uuid]", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryRegion'], [], [None]),
        "MemoryPersistentMemoryNamespaceConfigResult": MoMeta("MemoryPersistentMemoryNamespaceConfigResult", "memoryPersistentMemoryNamespaceConfigResult", "nscr-[name]", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfigResult'], [], [None]),
        "MemoryPersistentMemoryRegion": MoMeta("MemoryPersistentMemoryRegion", "memoryPersistentMemoryRegion", "region-[id]", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [u'memoryPersistentMemoryNamespace'], [None]),
        "MemoryPersistentMemorySecurity": MoMeta("MemoryPersistentMemorySecurity", "memoryPersistentMemorySecurity", "pmemory-security", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryLogicalConfiguration'], [u'memoryPersistentMemoryLocalSecurity'], [None]),
        "MemoryPersistentMemoryUnit": MoMeta("MemoryPersistentMemoryUnit", "memoryPersistentMemoryUnit", "pmem-[id]", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryArray'], [], [None]),
        ...
        "MgmtController": MoMeta("MgmtController", "mgmtController", "mgmt", VersionMeta.Version151f, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'adaptorUnit', u'cloudDeviceConnectorEp', u'computeRackUnit', u'storageSasExpander'], [u'firmwareBootDefinition', u'firmwareRunning', u'firmwareUpdatable', u'mgmtIf', u'sysdebugMEpLog'], ["Get"]),
        ...
        "MoInvKv": MoMeta("MoInvKv", "moInvKv", "kv-[key]", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["read-only"], [u'moKvInvHolder'], [], [None]),
        "MoKvInvHolder": MoMeta("MoKvInvHolder", "moKvInvHolder", "inv-kv-hostOs", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["read-only"], [u'computeRackUnit'], [u'moInvKv'], [None]),
        ...
        "PciLink": MoMeta("PciLink", "pciLink", "pci-link-[adapter]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["read-only"], [u'pciSwitch'], [], [None]),
        "PciSwitch": MoMeta("PciSwitch", "pciSwitch", "pci-switch-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["read-only"], [u'computeBoard'], [u'faultInst', u'pciLink'], [None]),
        ...
        "PsuRedundancyPolicy": MoMeta("PsuRedundancyPolicy", "psuRedundancyPolicy", "psu-redundancy-policy", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [], [None]),
        ...
        "StorageControllerNVMe": MoMeta("StorageControllerNVMe", "storageControllerNVMe", "storage-NVMe-[id]", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'faultInst', u'firmwareRunning', u'storageNVMePhysicalDrive'], ["Get"]),
        "StorageControllerNextConsistencyCheckSchedule": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "StorageControllerNextPatrolReadSchedule": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        ...
        "StorageFlexUtilHealth": MoMeta("StorageFlexUtilHealth", "storageFlexUtilHealth", "health", VersionMeta.Version304a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], ["Get"]),
        "StorageFlexUtilOperationalProfile": MoMeta("StorageFlexUtilOperationalProfile", "storageFlexUtilOperationalProfile", "oper-profile", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], ["Get", "Set"]),
        "StorageFlexUtilPhysicalDrive": MoMeta("StorageFlexUtilPhysicalDrive", "storageFlexUtilPhysicalDrive", "card-[physical_drive]", VersionMeta.Version304a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], ["Get"]),
        "StorageFlexUtilVirtualDrive": MoMeta("StorageFlexUtilVirtualDrive", "storageFlexUtilVirtualDrive", "vd-[partition_name]", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], ["Get", "Set"]),
        "StorageFlexUtilVirtualDriveImageMap": MoMeta("StorageFlexUtilVirtualDriveImageMap", "storageFlexUtilVirtualDriveImageMap", "vdrive-map-[virtual_drive]", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], ["Get", "Set"]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageControllerNVMe'], [u'faultInst'], ["Get"]),
        "StorageOperation": MoMeta("StorageOperation", "storageOperation", "storage-operation", VersionMeta.Version201a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageLocalDisk', u'storageVirtualDrive'], [], ["Get"]),
        "StorageRaidBattery": MoMeta("StorageRaidBattery", "storageRaidBattery", "raid-battery", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [u'faultInst'], ["Get", "Set"]),
    ...
    "modular": {
        ...
        "BiosVfAutoCCState": MoMeta("BiosVfAutoCCState", "biosVfAutoCCState", "auto-cc-state", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfEPPProfile": MoMeta("BiosVfEPPProfile", "biosVfEPPProfile", "epp-profile", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfEnergyEfficientTurbo": MoMeta("BiosVfEnergyEfficientTurbo", "biosVfEnergyEfficientTurbo", "energy-efficient-turbo", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfIMCInterleave": MoMeta("BiosVfIMCInterleave", "biosVfIMCInterleave", "imc-interleave", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIPV6PXE": MoMeta("BiosVfIPV6PXE", "biosVfIPV6PXE", "IPv6-Pxe", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfKTIPrefetch": MoMeta("BiosVfKTIPrefetch", "biosVfKTIPrefetch", "kti-prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfLLCPrefetch": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfPSata": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfSubNumaClustering": MoMeta("BiosVfSubNumaClustering", "biosVfSubNumaClustering", "sub-numa-cluster", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfTPMControl": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfTXTSupport": MoMeta("BiosVfTXTSupport", "biosVfTXTSupport", "TXT-Support", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfXPTPrefetch": MoMeta("BiosVfXPTPrefetch", "biosVfXPTPrefetch", "xpt-prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "CloudDeviceConnectorEp": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["read-only"], [u'cloudMgmtSvc'], [u'faultInst', u'mgmtController'], [None]),
        "CloudMgmtSvc": MoMeta("CloudMgmtSvc", "cloudMgmtSvc", "cloud-mgmt", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["read-only"], [u'topSystem'], [u'cloudDeviceConnectorEp'], [None]),
        ...
        "CommSavedVMediaMap": MoMeta("CommSavedVMediaMap", "commSavedVMediaMap", "saved-vmmap-[volume_name]", VersionMeta.Version301c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commVMedia'], [], ["Get", "Remove", "Set"]),
        "CommSnmp": MoMeta("CommSnmp", "commSnmp", "snmp-svc", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commSvcEp'], [u'commSnmpConfigCommit', u'commSnmpTrap', u'commSnmpUser'], ["Get", "Set"]),
        "CommSnmpConfigCommit": MoMeta("CommSnmpConfigCommit", "commSnmpConfigCommit", "snmp-config-commit", VersionMeta.Version401a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commSnmp'], [], [None]),
        ...
        "MailRecipient": MoMeta("MailRecipient", "mailRecipient", "mail-recipient-[id]", VersionMeta.Version303a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commMailAlert'], [], ["Get", "Remove", "Set"]),
        "MemoryArray": MoMeta("MemoryArray", "memoryArray", "memarray-[id]", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'faultInst', u'memoryPersistentMemoryUnit', u'memoryUnit'], ["Get", "Set"]),
        "MemoryPersistentMemoryBackup": MoMeta("MemoryPersistentMemoryBackup", "memoryPersistentMemoryBackup", "export-config", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [], [None]),
        "MemoryPersistentMemoryConfigResult": MoMeta("MemoryPersistentMemoryConfigResult", "memoryPersistentMemoryConfigResult", "cfg-result", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [u'memoryPersistentMemoryNamespaceConfigResult'], [None]),
        "MemoryPersistentMemoryConfiguration": MoMeta("MemoryPersistentMemoryConfiguration", "memoryPersistentMemoryConfiguration", "pmemory-config", VersionMeta.Version404b, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'memoryPersistentMemoryBackup', u'memoryPersistentMemoryConfigResult', u'memoryPersistentMemoryImporter', u'memoryPersistentMemoryRegion'], [None]),
        "MemoryPersistentMemoryDimms": MoMeta("MemoryPersistentMemoryDimms", "memoryPersistentMemoryDimms", "pmemory-dimms-[socket_id]", VersionMeta.Version404b, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryLogicalConfiguration'], [], [None]),
        ...
        "StorageControllerHealth": MoMeta("StorageControllerHealth", "storageControllerHealth", "controller-health", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], ["Get"]),
        "StorageControllerNVMe": MoMeta("StorageControllerNVMe", "storageControllerNVMe", "storage-NVMe-[id]", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'faultInst', u'firmwareRunning', u'storageNVMePhysicalDrive'], ["Get"]),
        "StorageControllerNextConsistencyCheckSchedule": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "StorageControllerNextPatrolReadSchedule": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageControllerNVMe'], [u'faultInst'], ["Get"]),
        "StorageOperation": MoMeta("StorageOperation", "storageOperation", "storage-operation", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageLocalDisk', u'storageVirtualDrive'], [], ["Get"]),
        "StorageRaidBattery": MoMeta("StorageRaidBattery", "storageRaidBattery", "raid-battery", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [u'faultInst'], ["Get", "Set"]),
        ...
        "TopSystem": MoMeta("TopSystem", "topSystem", "sys", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'topRoot'], [u'aaaLdap', u'aaaUserEp', u'certificateManagement', u'cloudMgmtSvc', u'commSvcEp', u'equipmentChassis', u'sysdebugTechSupportExport'], ["Get", "Set"]),
        "UploadBiosProfile": MoMeta("UploadBiosProfile", "uploadBiosProfile", "upload-bios-profile", VersionMeta.Version301c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosProfileManagement'], [], [None]),
        ...
        "AdapterSecureUpdate": MoMeta("AdapterSecureUpdate", "adapterSecureUpdate", "adapter-secure-update", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeServerNode'], [], [None]),
        ...
        "EquipmentSystemIOController": MoMeta("EquipmentSystemIOController", "equipmentSystemIOController", "slot-[id]", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'equipmentChassis'], [u'commEpIpmiLan', u'equipmentSharedIOModule', u'faultInst', u'mgmtController', u'siocResetReason', u'systemIOControllerNVMe'], ["Get", "Set"]),
        "IoControllerNVMePhysicalDrive": MoMeta("IoControllerNVMePhysicalDrive", "ioControllerNVMePhysicalDrive", "pd-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'systemIOControllerNVMe'], [u'faultInst'], [None]),
        ...
        "SystemIOControllerNVMe": MoMeta("SystemIOControllerNVMe", "systemIOControllerNVMe", "sioc-NVMe-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'equipmentSystemIOController'], [u'faultInst', u'ioControllerNVMePhysicalDrive'], [None]),
