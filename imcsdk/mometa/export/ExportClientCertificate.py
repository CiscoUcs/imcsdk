...
class ExportClientCertificate(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("ExportClientCertificate", "exportClientCertificate", "kmip-client-cert-export", VersionMeta.Version302b, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None]),
        "modular": MoMeta("ExportClientCertificate", "exportClientCertificate", "kmip-client-cert-export", VersionMeta.Version303a, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None])
    }
