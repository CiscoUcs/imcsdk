...
class ComputeSharedIOMbPowerStats(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("ComputeSharedIOMbPowerStats", "computeSharedIOMbPowerStats", "power-stats", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'equipmentSharedIOModule'], [], [None])
    }
