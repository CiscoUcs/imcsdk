...
class PsuRedundancyPolicy(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("PsuRedundancyPolicy", "psuRedundancyPolicy", "psu-redundancy-policy", VersionMeta.Version313h, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], [u'computeBoard'], [], [None]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "redundancy_policy": MoPropertyMeta("redundancy_policy", "redundancyPolicy", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["grid", "n-plus-one", "non-redundant"], []), 
            ...
            "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x8, 0, 255, None, [], []), 
            "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["", "created", "deleted", "modified", "removed"], []), 
        },
