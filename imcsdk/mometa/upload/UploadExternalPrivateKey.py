"""This module contains the general information for UploadExternalPrivateKey ManagedObject."""
...
class UploadExternalPrivateKeyConsts:
...
class UploadExternalPrivateKey(ManagedObject):
    """This is UploadExternalPrivateKey class."""

    consts = UploadExternalPrivateKeyConsts()
    naming_props = set([])

    mo_meta = {
        "classic": MoMeta("UploadExternalPrivateKey", "uploadExternalPrivateKey", "external-pvt-key-upload", VersionMeta.Version412a, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ['certificateManagement'], [], [None]),
        "modular": MoMeta("UploadExternalPrivateKey", "uploadExternalPrivateKey", "external-pvt-key-upload", VersionMeta.Version412a, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ['certificateManagement'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "protocol": MoPropertyMeta("protocol", "protocol", "string", VersionMeta.Version412a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["none", "scp", "sftp"], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "UploadExternalPrivateKey", parent_mo_or_dn, **kwargs)
