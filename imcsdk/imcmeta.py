...
MO_CLASS_META = {
    "classic": {
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "BiosUnit": MoMeta("BiosUnit", "biosUnit", "bios", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeRackUnit'], ['biosBOT', 'biosPlatformDefaults', 'biosProfileManagement', 'biosSettings', 'firmwareBootDefinition', 'firmwareRunning', 'firmwareUpdatable', 'secureBootCertificateManagement'], ["Get", "Set"]),
        ...
        "PciAdapterFruInventory": MoMeta("PciAdapterFruInventory", "pciAdapterFruInventory", "pci-adapter-fru-[id]", VersionMeta.Version422a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['computeRackUnit'], ['pciAdapterFruInventoryInfo'], [None]),
