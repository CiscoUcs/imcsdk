...
class CommEpIpmiLan(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "key": MoPropertyMeta("key", "key", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, None, None, r"""[a-fA-F0-9]{40}""", [], []), 
            "priv": MoPropertyMeta("priv", "priv", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["admin", "read-only", "user"], []), 
