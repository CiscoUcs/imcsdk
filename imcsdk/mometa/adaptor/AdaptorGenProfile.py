...
class AdaptorGenProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "physical_nic_mode": MoPropertyMeta("physical_nic_mode", "physicalNicMode", "string", VersionMeta.Version422a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
            "port_channel_enable": MoPropertyMeta("port_channel_enable", "portChannelEnable", "string", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
            ...
            "vntag_mode": MoPropertyMeta("vntag_mode", "vntagMode", "string", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
            ...
            "physical_nic_mode_capable": MoPropertyMeta("physical_nic_mode_capable", "physicalNicModeCapable", "string", VersionMeta.Version422a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []),
        ...
        "modular": {
            ...
            "physical_nic_mode": MoPropertyMeta("physical_nic_mode", "physicalNicMode", "string", VersionMeta.Version412a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
            "port_channel_enable": MoPropertyMeta("port_channel_enable", "portChannelEnable", "string", VersionMeta.Version404b, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
            ...
            "vntag_mode": MoPropertyMeta("vntag_mode", "vntagMode", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []),
    ...
    prop_map = {
        ...
        "classic": {
            ...
            "model": "model", 
            "pciSlot": "pci_slot", 
            "physicalNicModeCapable": "physical_nic_mode_capable", 
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        self.model = None
        self.pci_slot = None
        self.physical_nic_mode_capable = None
