...
class PowerBudget(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "eff_cpu_power": MoPropertyMeta("eff_cpu_power", "effCpuPower", "string", VersionMeta.Version313a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "eff_power": MoPropertyMeta("eff_power", "effPower", "string", VersionMeta.Version313a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
