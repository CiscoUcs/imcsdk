...
class ChassisPowerUtilization(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("ChassisPowerUtilization", "chassisPowerUtilization", "budget", VersionMeta.Version2013e, "OutputOnly", 0x7, [], ["admin", "read-only", "user"], [u'equipmentChassis'], [], [None])
    }
