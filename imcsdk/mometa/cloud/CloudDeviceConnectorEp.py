...
class CloudDeviceConnectorEp(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version402c, "OutputOnly", 0xf, [], ["read-only"], [u'cloudMgmtSvc'], [u'faultInst', u'mgmtController'], [None]),
        "modular": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version404b, "OutputOnly", 0xf, [], ["read-only"], [u'cloudMgmtSvc'], [u'faultInst', u'mgmtController'], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "description": MoPropertyMeta("description", "description", "string", VersionMeta.Version404b, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
