...
class BiosVfLLCPrefetch(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version313h, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vp_llc_prefetch": MoPropertyMeta("vp_llc_prefetch", "vpLLCPrefetch", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
