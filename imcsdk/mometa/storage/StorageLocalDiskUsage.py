...
class StorageLocalDiskUsage(ManagedObject):
    ...
    mo_meta = MoMeta("StorageLocalDiskUsage", "storageLocalDiskUsage", "pd-[physical_drive]", VersionMeta.Version151f, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageVirtualDrive'], [], ["Get"])
