...
class CurrentCertificate(ManagedObject):
    ...
    mo_meta = MoMeta("CurrentCertificate", "currentCertificate", "curr-cert", VersionMeta.Version209c, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'certificateManagement'], [], [None])
