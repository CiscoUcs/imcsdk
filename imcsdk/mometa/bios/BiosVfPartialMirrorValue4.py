...
class BiosVfPartialMirrorValue4(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfPartialMirrorValue4", "biosVfPartialMirrorValue4", "Partial-Mirror-Value4", VersionMeta.Version410a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfPartialMirrorValue4", "biosVfPartialMirrorValue4", "Partial-Mirror-Value4", VersionMeta.Version410a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_partial_mirror_value4": MoPropertyMeta("vp_partial_mirror_value4", "vpPartialMirrorValue4", "string", VersionMeta.Version410a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["platform-default"], ["0-65535"]), 
