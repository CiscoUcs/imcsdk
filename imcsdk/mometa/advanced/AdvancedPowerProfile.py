...
class AdvancedPowerProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AdvancedPowerProfile", "advancedPowerProfile", "advpwrprof", VersionMeta.Version202c, "InputOutput", 0x7ffff, [], ["admin", "read-only", "user"], [u'powerBudget'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "cpu_power_limit": MoPropertyMeta("cpu_power_limit", "cpuPowerLimit", "uint", VersionMeta.Version202c, MoPropertyMeta.READ_WRITE, 0x10, 0, 510, None, [], ["0-4294967295"]), 
