...
class StorageFlexFlashPhysicalDrive(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "dirty_partition_map": MoPropertyMeta("dirty_partition_map", "dirtyPartitionMap", "string", VersionMeta.Version311c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "stale_partition_map": MoPropertyMeta("stale_partition_map", "stalePartitionMap", "string", VersionMeta.Version311c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        },
