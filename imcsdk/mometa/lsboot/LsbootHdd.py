...
class LsbootHdd(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "slot": MoPropertyMeta("slot", "slot", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|M|HBA|SAS){0,1}""", [], []), 
