...
class CommSnmp(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("CommSnmp", "commSnmp", "snmp-svc", VersionMeta.Version151f, "InputOutput", 0x1fff, [], ["admin", "read-only", "user"], [u'commSvcEp'], [u'commSnmpConfigCommit', u'commSnmpTrap', u'commSnmpUser'], ["Get", "Set"]),
        "modular": MoMeta("CommSnmp", "commSnmp", "snmp-svc", VersionMeta.Version2013e, "InputOutput", 0x1fff, [], ["admin", "read-only", "user"], [u'commSvcEp'], [u'commSnmpConfigCommit', u'commSnmpTrap', u'commSnmpUser'], ["Get", "Set"])
    }
