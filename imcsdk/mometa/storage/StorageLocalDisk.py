...
class StorageLocalDisk(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "destination_pd_id": MoPropertyMeta("destination_pd_id", "destinationPDId", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x8, 0, 510, None, [], ["0-4294967295"]), 
            ...
            "pd_state": MoPropertyMeta("pd_state", "pdState", "string", VersionMeta.Version313a, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "modular": {
            ...
            "locator_led_status": MoPropertyMeta("locator_led_status", "locatorLEDStatus", "string", VersionMeta.Version401a, MoPropertyMeta.READ_ONLY, None, None, None, None, ["off", "on"], []), 
