...
class BiosVfEPPProfile(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfEPPProfile", "biosVfEPPProfile", "epp-profile", VersionMeta.Version313h, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vp_epp_profile": MoPropertyMeta("vp_epp_profile", "vpEPPProfile", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Balanced Performance", "Balanced Power", "Performance", "Power", "platform-default"], []), 
