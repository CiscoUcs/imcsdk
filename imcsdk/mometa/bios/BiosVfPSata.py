...
class BiosVfPSata(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version313h, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vp_p_sata": MoPropertyMeta("vp_p_sata", "vpPSata", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["AHCI", "Disabled", "LSI SW RAID", "platform-default"], []), 
