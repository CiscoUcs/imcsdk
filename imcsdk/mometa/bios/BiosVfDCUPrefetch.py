...
class BiosVfDCUPrefetch(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfDCUPrefetch", "biosVfDCUPrefetch", "DCU-Prefetch", VersionMeta.Version2013e, "InputOutput", 0x3f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
