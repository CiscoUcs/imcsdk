...
class StandardPowerProfile(ManagedObject):
    ...
    mo_meta = MoMeta("StandardPowerProfile", "standardPowerProfile", "stdpwrprof", VersionMeta.Version202c, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [u'powerBudget'], [], ["Get", "Set"])
