...
class BiosVfIMCInterleave(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfIMCInterleave", "biosVfIMCInterleave", "imc-interleave", VersionMeta.Version311a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [" SET", "GET"]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_imc_interleave": MoPropertyMeta("vp_imc_interleave", "vpIMCInterleave", "string", VersionMeta.Version311a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["1-way Interleave", "2-way Interleave", "Auto", "platform-default"], []), 
        },
