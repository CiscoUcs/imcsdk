...
class ComputeServerRef(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("ComputeServerRef", "computeServerRef", "upload-catalog", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageEnclosureDiskSlotEp'], [], [None])
    }
