...
MO_CLASS_META = {
    "classic": {
        "AaaLdap": MoMeta("AaaLdap", "aaaLdap", "ldap-ext", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['aaaLdapRoleGroup', 'ldapCACertificateManagement'], ["Get", "Set"]),
        ...
        "AaaUser": MoMeta("AaaUser", "aaaUser", "user-[id]", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['aaaUserEp'], [], ["Get", "Set"]),
        "AaaUserEp": MoMeta("AaaUserEp", "aaaUserEp", "user-ext", VersionMeta.Version151f, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['aaaSession', 'aaaUser', 'aaaUserPasswordExpiration', 'aaaUserPolicy', 'generateRandomPassword'], ["Get"]),
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version411d, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "BiosVfAssertNMIOnPERR": MoMeta("BiosVfAssertNMIOnPERR", "biosVfAssertNMIOnPERR", "Assert-NMI-on-PERR", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        "BiosVfAssertNMIOnSERR": MoMeta("BiosVfAssertNMIOnSERR", "biosVfAssertNMIOnSERR", "Assert-NMI-on-SERR", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfDirectCacheAccess": MoMeta("BiosVfDirectCacheAccess", "biosVfDirectCacheAccess", "Direct-Cache-Access", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfExecuteDisableBit": MoMeta("BiosVfExecuteDisableBit", "biosVfExecuteDisableBit", "Execute-Disable-Bit", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIntelVTForDirectedIO": MoMeta("BiosVfIntelVTForDirectedIO", "biosVfIntelVTForDirectedIO", "Intel-VT-for-directed-IO", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfLvDIMMSupport": MoMeta("BiosVfLvDIMMSupport", "biosVfLvDIMMSupport", "LvDIMM-Support", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfMirroringMode": MoMeta("BiosVfMirroringMode", "biosVfMirroringMode", "Mirroring-Mode", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfPOSTErrorPause": MoMeta("BiosVfPOSTErrorPause", "biosVfPOSTErrorPause", "POST-error-pause", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfProcessorC3Report": MoMeta("BiosVfProcessorC3Report", "biosVfProcessorC3Report", "Processor-C3-Report", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfProcessorCState": MoMeta("BiosVfProcessorCState", "biosVfProcessorCState", "Processor-C-State", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfSerialPortAEnable": MoMeta("BiosVfSerialPortAEnable", "biosVfSerialPortAEnable", "Serial-port-A-enable", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfSparingMode": MoMeta("BiosVfSparingMode", "biosVfSparingMode", "Sparing-Mode", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfUSBBootConfig": MoMeta("BiosVfUSBBootConfig", "biosVfUSBBootConfig", "USB-Boot-Config", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "CertificateManagement": MoMeta("CertificateManagement", "certificateManagement", "cert-mgmt", VersionMeta.Version209c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['currentCertificate', 'generateCertificateSigningRequest', 'uploadCertificate'], ["Get"]),
        ...
        "LsbootDevPrecision": MoMeta("LsbootDevPrecision", "lsbootDevPrecision", "boot-precision", VersionMeta.Version201a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeRackUnit'], ['lsbootCdd', 'lsbootHdd', 'lsbootIscsi', 'lsbootNVMe', 'lsbootPchStorage', 'lsbootPxe', 'lsbootSan', 'lsbootSd', 'lsbootUefiShell', 'lsbootUsb', 'lsbootVMedia'], ["Get", "Set"]),
        ...
        "PsuRedundancyPolicy": MoMeta("PsuRedundancyPolicy", "psuRedundancyPolicy", "psu-redundancy-policy", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeBoard'], [], [None]),
        ...
        "StorageControllerNextConsistencyCheckSchedule": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['storageController'], [], [None]),
        "StorageControllerNextPatrolReadSchedule": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['storageController'], [], [None]),
        ...
        "StorageFlexUtilPhysicalDrive": MoMeta("StorageFlexUtilPhysicalDrive", "storageFlexUtilPhysicalDrive", "card-[physical_drive]", VersionMeta.Version304a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['storageFlexUtilController'], [], ["Get"]),
        "StorageFlexUtilVirtualDrive": MoMeta("StorageFlexUtilVirtualDrive", "storageFlexUtilVirtualDrive", "vd-[partition_name]", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['storageFlexUtilController'], [], ["Get", "Set"]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['storageControllerNVMe'], ['faultInst'], ["Get"]),
    ...
    "modular": {
        "AaaLdap": MoMeta("AaaLdap", "aaaLdap", "ldap-ext", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['aaaLdapRoleGroup', 'ldapCACertificateManagement'], ["Get", "Set"]),
        ...
        "AaaUser": MoMeta("AaaUser", "aaaUser", "user-[id]", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['aaaUserEp'], [], ["Get", "Set"]),
        "AaaUserEp": MoMeta("AaaUserEp", "aaaUserEp", "user-ext", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['aaaSession', 'aaaUser', 'aaaUserPasswordExpiration', 'aaaUserPolicy', 'generateRandomPassword'], ["Get"]),
        "AaaUserPasswordExpiration": MoMeta("AaaUserPasswordExpiration", "aaaUserPasswordExpiration", "password-expiration", VersionMeta.Version301c, "InputOutput", 0x1, [], ["admin", "user"], ['aaaUserEp'], [], ["Get", "Set"]),
        ...
        "BiosVfAutoCCState": MoMeta("BiosVfAutoCCState", "biosVfAutoCCState", "auto-cc-state", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfEPPProfile": MoMeta("BiosVfEPPProfile", "biosVfEPPProfile", "epp-profile", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfEnergyEfficientTurbo": MoMeta("BiosVfEnergyEfficientTurbo", "biosVfEnergyEfficientTurbo", "energy-efficient-turbo", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfIMCInterleave": MoMeta("BiosVfIMCInterleave", "biosVfIMCInterleave", "imc-interleave", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIPV4PXE": MoMeta("BiosVfIPV4PXE", "biosVfIPV4PXE", "IPv4-Pxe", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfIPV6PXE": MoMeta("BiosVfIPV6PXE", "biosVfIPV6PXE", "IPv6-Pxe", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfKTIPrefetch": MoMeta("BiosVfKTIPrefetch", "biosVfKTIPrefetch", "kti-prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        "BiosVfLLCPrefetch": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfMemorySizeLimit": MoMeta("BiosVfMemorySizeLimit", "biosVfMemorySizeLimit", "Memory-Size-Limit", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfNetworkStack": MoMeta("BiosVfNetworkStack", "biosVfNetworkStack", "Network-Stack", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfPCIeRASSupport": MoMeta("BiosVfPCIeRASSupport", "biosVfPCIeRASSupport", "PCIe-RAS-Support", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfPSata": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfPartialMirrorModeConfig": MoMeta("BiosVfPartialMirrorModeConfig", "biosVfPartialMirrorModeConfig", "Partial-Mirror-Mode", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPartialMirrorPercent": MoMeta("BiosVfPartialMirrorPercent", "biosVfPartialMirrorPercent", "Partial-Mirror-Percent", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPartialMirrorValue1": MoMeta("BiosVfPartialMirrorValue1", "biosVfPartialMirrorValue1", "Partial-Mirror-Value1", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPartialMirrorValue2": MoMeta("BiosVfPartialMirrorValue2", "biosVfPartialMirrorValue2", "Partial-Mirror-Value2", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPartialMirrorValue3": MoMeta("BiosVfPartialMirrorValue3", "biosVfPartialMirrorValue3", "Partial-Mirror-Value3", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPartialMirrorValue4": MoMeta("BiosVfPartialMirrorValue4", "biosVfPartialMirrorValue4", "Partial-Mirror-Value4", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfSelectPprType": MoMeta("BiosVfSelectPprType", "biosVfSelectPprType", "select-ppr-type", VersionMeta.Version410a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfSubNumaClustering": MoMeta("BiosVfSubNumaClustering", "biosVfSubNumaClustering", "sub-numa-cluster", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        "BiosVfTPMControl": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfTXTSupport": MoMeta("BiosVfTXTSupport", "biosVfTXTSupport", "TXT-Support", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfXPTPrefetch": MoMeta("BiosVfXPTPrefetch", "biosVfXPTPrefetch", "xpt-prefetch", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], ["Get", "Set"]),
        "CertificateManagement": MoMeta("CertificateManagement", "certificateManagement", "cert-mgmt", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['currentCertificate', 'generateCertificateSigningRequest', 'uploadCertificate'], ["Get"]),
        "CloudDeviceConnectorEp": MoMeta("CloudDeviceConnectorEp", "cloudDeviceConnectorEp", "device-connector", VersionMeta.Version410a, "OutputOnly", 0x1, [], ["read-only"], ['cloudMgmtSvc'], ['faultInst', 'mgmtController'], [None]),
        "CloudMgmtSvc": MoMeta("CloudMgmtSvc", "cloudMgmtSvc", "cloud-mgmt", VersionMeta.Version410a, "OutputOnly", 0x1, [], ["read-only"], ['topSystem'], ['cloudDeviceConnectorEp'], [None]),
        ...
        "GraphicsCard": MoMeta("GraphicsCard", "graphicsCard", "graphics-card-[id]", VersionMeta.Version410a, "OutputOnly", 0x1, [], ["read-only"], ['computeBoard'], [], [None]),
        ...
        "LsbootDevPrecision": MoMeta("LsbootDevPrecision", "lsbootDevPrecision", "boot-precision", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeServerNode'], ['lsbootHdd', 'lsbootIscsi', 'lsbootNVMe', 'lsbootPchStorage', 'lsbootPxe', 'lsbootSan', 'lsbootSd', 'lsbootUefiShell', 'lsbootUsb', 'lsbootVMedia'], ["Get", "Set"]),
        ...
        "TopSystem": MoMeta("TopSystem", "topSystem", "sys", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['topRoot'], ['aaaLdap', 'aaaUserEp', 'certificateManagement', 'cloudMgmtSvc', 'commSvcEp', 'equipmentChassis', 'sysdebugTechSupportExport'], ["Get", "Set"]),
        "UploadBiosProfile": MoMeta("UploadBiosProfile", "uploadBiosProfile", "upload-bios-profile", VersionMeta.Version301c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['biosProfileManagement'], [], [None]),
        ...
        "AdapterSecureUpdate": MoMeta("AdapterSecureUpdate", "adapterSecureUpdate", "adapter-secure-update", VersionMeta.Version313a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeServerNode'], [], [None]),
        ...
        "GraphicsCardTemperature": MoMeta("GraphicsCardTemperature", "graphicsCardTemperature", "graphics-card-temp-[id]", VersionMeta.Version410a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['pciEquipSlot'], [], [None]),
        "IoControllerNVMePhysicalDrive": MoMeta("IoControllerNVMePhysicalDrive", "ioControllerNVMePhysicalDrive", "pd-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['systemIOControllerNVMe'], ['faultInst'], [None]),
        ...
        "SystemIOControllerNVMe": MoMeta("SystemIOControllerNVMe", "systemIOControllerNVMe", "sioc-NVMe-[id]", VersionMeta.Version402c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['equipmentSystemIOController'], ['faultInst', 'ioControllerNVMePhysicalDrive'], [None]),
