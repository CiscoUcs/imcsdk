...
class CommSnmpTrap(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("CommSnmpTrap", "commSnmpTrap", "snmp-trap-[id]", VersionMeta.Version151f, "InputOutput", 0x1fff, [], ["admin", "read-only", "user"], [u'commSnmp'], [], ["Get", "Set"]),
        "modular": MoMeta("CommSnmpTrap", "commSnmpTrap", "snmp-trap-[id]", VersionMeta.Version2013e, "InputOutput", 0x1fff, [], ["admin", "read-only", "user"], [u'commSnmp'], [], ["Get", "Set"])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "config_change": MoPropertyMeta("config_change", "configChange", "string", VersionMeta.Version401c, MoPropertyMeta.READ_WRITE, 0x8, 0, 510, None, ["commit", "no-commit"], []), 
