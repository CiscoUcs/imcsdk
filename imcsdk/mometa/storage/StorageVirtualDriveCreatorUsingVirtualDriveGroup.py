...
class StorageVirtualDriveCreatorUsingVirtualDriveGroup(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "read_policy": MoPropertyMeta("read_policy", "readPolicy", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x40, None, None, None, ["", "always-read-ahead", "no-read-ahead"], []), 
            ...
            "size": MoPropertyMeta("size", "size", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 1, 510, r"""(\d+\s?([MGT]B)?)""", [], []), 
            ...
            "strip_size": MoPropertyMeta("strip_size", "stripSize", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x800, 0, 510, None, ["1024k", "128k", "256k", "512k", "64k"], []), 
