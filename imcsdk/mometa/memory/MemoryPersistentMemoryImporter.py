...
class MemoryPersistentMemoryImporter(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("MemoryPersistentMemoryImporter", "memoryPersistentMemoryImporter", "import-config", VersionMeta.Version404b, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [], [None]),
        "modular": MoMeta("MemoryPersistentMemoryImporter", "memoryPersistentMemoryImporter", "import-config", VersionMeta.Version404b, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], [u'memoryPersistentMemoryConfiguration'], [], [None])
    }
