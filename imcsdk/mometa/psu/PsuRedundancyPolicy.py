...
class PsuRedundancyPolicy(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("PsuRedundancyPolicy", "psuRedundancyPolicy", "psu-redundancy-policy", VersionMeta.Version313a, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], ['computeBoard'], [], [None]),
    }
