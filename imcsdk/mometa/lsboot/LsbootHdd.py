...
class LsbootHdd(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "slot": MoPropertyMeta("slot", "slot", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|MRAID|RAID){0,1}""", [], []), 
        ...
        "modular": {
            ...
            "slot": MoPropertyMeta("slot", "slot", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x20, None, None, r"""([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|M|HBA|SBMezz1|SBMezz2|IOEMezz1){0,1}""", [], []), 
