...
class FanPolicyConsts:
    ...
    CONFIGURED_FAN_POLICY_MAXIMUM_COOLING = "Maximum Cooling"
...
class FanPolicy(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "configured_fan_policy": MoPropertyMeta("configured_fan_policy", "configuredFanPolicy", "string", VersionMeta.Version301c, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["Acoustic", "Balanced", "High Power", "Low Power", "Maximum Cooling", "Maximum Power", "Performance"], []),
