...
class GenerateCertificateSigningRequest(ManagedObject):
    ...
    mo_meta = MoMeta("GenerateCertificateSigningRequest", "generateCertificateSigningRequest", "gen-csr-req", VersionMeta.Version209c, "InputOutput", 0x1ffff, [], ["admin", "read-only", "user"], [u'certificateManagement'], [], [None])
