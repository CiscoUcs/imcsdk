...
class CommSnmpConfigCommit(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("CommSnmpConfigCommit", "commSnmpConfigCommit", "snmp-config-commit", VersionMeta.Version401a, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], ['commSnmp'], [], [None])
    }
