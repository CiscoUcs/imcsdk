...
class StorageControllerNextConsistencyCheckSchedule(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageController'], [], [None]),
        "modular": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageController'], [], [None])
    }
