...
class BiosVfAutoCCState(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfAutoCCState", "biosVfAutoCCState", "auto-cc-state", VersionMeta.Version313a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
