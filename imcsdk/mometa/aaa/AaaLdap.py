...
class AaaLdap(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "dns_search_domain": MoPropertyMeta("dns_search_domain", "dnsSearchDomain", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x100, 0, 64, r"""[a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]""", [], []), 
            "dns_search_forest": MoPropertyMeta("dns_search_forest", "dnsSearchForest", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 0, 64, r"""[a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]""", [], []), 
