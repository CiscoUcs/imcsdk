...
class BiosVfCiscoOpromLaunchOptimization(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfCiscoOpromLaunchOptimization", "biosVfCiscoOpromLaunchOptimization", "Cisco-Opromlaunch-Optimize", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
