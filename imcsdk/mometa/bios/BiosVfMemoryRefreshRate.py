...
class BiosVfMemoryRefreshRate(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfMemoryRefreshRate", "biosVfMemoryRefreshRate", "Memory-Refresh-Rate", VersionMeta.Version412a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfMemoryRefreshRate", "biosVfMemoryRefreshRate", "Memory-Refresh-Rate", VersionMeta.Version412a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_memory_refresh_rate": MoPropertyMeta("vp_memory_refresh_rate", "vpMemoryRefreshRate", "string", VersionMeta.Version412a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["1x Refresh", "2x Refresh", "platform-default"], []),
