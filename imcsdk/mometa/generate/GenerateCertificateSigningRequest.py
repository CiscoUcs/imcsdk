...
class GenerateCertificateSigningRequest(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("GenerateCertificateSigningRequest", "generateCertificateSigningRequest", "gen-csr-req", VersionMeta.Version209c, "InputOutput", 0x1ffffffffff, [], ["admin", "read-only", "user"], [u'certificateManagement'], [], [None]),
        "modular": MoMeta("GenerateCertificateSigningRequest", "generateCertificateSigningRequest", "gen-csr-req", VersionMeta.Version2013e, "InputOutput", 0x1ffffffffff, [], ["admin", "read-only", "user"], [u'certificateManagement'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version209c, MoPropertyMeta.READ_WRITE, 0x1000, None, None, r"""[^\(\)~`'\?\\"";<>\|&\*\^$%]{0,255}""", [], []), 
            ...
            "subject_alt_name_type1": MoPropertyMeta("subject_alt_name_type1", "subjectAltNameType1", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x100000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type10": MoPropertyMeta("subject_alt_name_type10", "subjectAltNameType10", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x200000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type2": MoPropertyMeta("subject_alt_name_type2", "subjectAltNameType2", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x400000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type3": MoPropertyMeta("subject_alt_name_type3", "subjectAltNameType3", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x800000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type4": MoPropertyMeta("subject_alt_name_type4", "subjectAltNameType4", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x1000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type5": MoPropertyMeta("subject_alt_name_type5", "subjectAltNameType5", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x2000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type6": MoPropertyMeta("subject_alt_name_type6", "subjectAltNameType6", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x4000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type7": MoPropertyMeta("subject_alt_name_type7", "subjectAltNameType7", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x8000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type8": MoPropertyMeta("subject_alt_name_type8", "subjectAltNameType8", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type9": MoPropertyMeta("subject_alt_name_type9", "subjectAltNameType9", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x20000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_value1": MoPropertyMeta("subject_alt_name_value1", "subjectAltNameValue1", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x40000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value10": MoPropertyMeta("subject_alt_name_value10", "subjectAltNameValue10", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x80000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value2": MoPropertyMeta("subject_alt_name_value2", "subjectAltNameValue2", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x100000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value3": MoPropertyMeta("subject_alt_name_value3", "subjectAltNameValue3", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x200000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value4": MoPropertyMeta("subject_alt_name_value4", "subjectAltNameValue4", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x400000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value5": MoPropertyMeta("subject_alt_name_value5", "subjectAltNameValue5", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x800000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value6": MoPropertyMeta("subject_alt_name_value6", "subjectAltNameValue6", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x1000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value7": MoPropertyMeta("subject_alt_name_value7", "subjectAltNameValue7", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x2000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value8": MoPropertyMeta("subject_alt_name_value8", "subjectAltNameValue8", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x4000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value9": MoPropertyMeta("subject_alt_name_value9", "subjectAltNameValue9", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x8000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
        ...
        "modular": {
            "add_challenge_password": MoPropertyMeta("add_challenge_password", "addChallengePassword", "string", VersionMeta.Version401c, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["No", "Yes", "no", "yes"], []), 
            "challenge_password": MoPropertyMeta("challenge_password", "challengePassword", "string", VersionMeta.Version401c, MoPropertyMeta.READ_WRITE, 0x4, 0, 20, r"""[^""#]{0,20}""", [], []), 
            ...
            "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x1000, None, None, r"""[^\(\)~`'\?\\"";<>\|&\*\^$%]{0,255}""", [], []), 
            "remote_server": MoPropertyMeta("remote_server", "remoteServer", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x2000, 0, 255, r"""(https?://)?([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [], []), 
            ...
            "string_mask": MoPropertyMeta("string_mask", "stringMask", "string", VersionMeta.Version401c, MoPropertyMeta.READ_WRITE, 0x80000, 0, 8, None, ["default", "nombstr", "pkix", "utf8only"], []), 
            "subject_alt_name_type1": MoPropertyMeta("subject_alt_name_type1", "subjectAltNameType1", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x100000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type10": MoPropertyMeta("subject_alt_name_type10", "subjectAltNameType10", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x200000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type2": MoPropertyMeta("subject_alt_name_type2", "subjectAltNameType2", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x400000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type3": MoPropertyMeta("subject_alt_name_type3", "subjectAltNameType3", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x800000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
