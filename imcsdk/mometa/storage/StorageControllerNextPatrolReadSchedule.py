...
class StorageControllerNextPatrolReadSchedule(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version401a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "modular": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313h, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageController'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "pr_schedule_mode": MoPropertyMeta("pr_schedule_mode", "prScheduleMode", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "pr_state": MoPropertyMeta("pr_state", "prState", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
