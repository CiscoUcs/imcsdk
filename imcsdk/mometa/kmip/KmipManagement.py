...
class KmipManagement(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("KmipManagement", "kmipManagement", "kmip-mgmt", VersionMeta.Version303a, "InputOutput", 0x3f, [], ["admin", "read-only", "user"], [u'computeServerNode'], [u'downloadClientCertificate', u'downloadClientPrivateKey', u'downloadRootCACertificate', u'exportClientCertificate', u'exportClientPrivateKey', u'exportRootCACertificate', u'kmipServer', u'kmipServerLogin'], [None])
    }
