...
class StorageEnclosureDiskSlotEp(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("StorageEnclosureDiskSlotEp", "storageEnclosureDiskSlotEp", "upload-catalog", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageEnclosure'], [u'computeServerRef', u'faultInst'], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_ONLY, 0x200, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []), 
        },
