...
class AdaptorEthGenProfile(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("AdaptorEthGenProfile", "adaptorEthGenProfile", "general", VersionMeta.Version2013e, "InputOutput", 0x1fff, [], ["admin", "read-only", "user"], [u'adaptorHostEthIf'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "rate_limit": MoPropertyMeta("rate_limit", "rateLimit", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["OFF"], ["1-40000"]), 
