...
class AutoPowerProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "prior_server_id": MoPropertyMeta("prior_server_id", "priorServerId", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 0, 510, None, [], ["1-2"]), 
            "priority": MoPropertyMeta("priority", "priority", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 0, 510, None, ["dynamic", "manual"], []), 
