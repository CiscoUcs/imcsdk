...
MO_CLASS_META = {
    "classic": {
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "BiosVfBootOptionNumRetry": MoMeta("BiosVfBootOptionNumRetry", "biosVfBootOptionNumRetry", "Boot-option-num-retry", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfBootOptionReCoolDown": MoMeta("BiosVfBootOptionReCoolDown", "biosVfBootOptionReCoolDown", "Boot-option-cool-down-retry", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfPSata": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfTPMControl": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "LsbootCdd": MoMeta("LsbootCdd", "lsbootCdd", "cdd-[name]", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'lsbootDevPrecision'], [], [None]),
        ...
        "StorageFlexUtilController": MoMeta("StorageFlexUtilController", "storageFlexUtilController", "storage-flexutil-[id]", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'storageFlexUtilHealth', u'storageFlexUtilOperationalProfile', u'storageFlexUtilPhysicalDrive', u'storageFlexUtilVirtualDrive', u'storageFlexUtilVirtualDriveImageMap'], [None]),
        "StorageFlexUtilHealth": MoMeta("StorageFlexUtilHealth", "storageFlexUtilHealth", "health", VersionMeta.Version311c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], [None]),
        "StorageFlexUtilOperationalProfile": MoMeta("StorageFlexUtilOperationalProfile", "storageFlexUtilOperationalProfile", "oper-profile", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], [None]),
        "StorageFlexUtilPhysicalDrive": MoMeta("StorageFlexUtilPhysicalDrive", "storageFlexUtilPhysicalDrive", "card-[physical_drive_id]", VersionMeta.Version311c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], [None]),
        "StorageFlexUtilVirtualDrive": MoMeta("StorageFlexUtilVirtualDrive", "storageFlexUtilVirtualDrive", "vd-[partition_name]", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], [None]),
        "StorageFlexUtilVirtualDriveImageMap": MoMeta("StorageFlexUtilVirtualDriveImageMap", "storageFlexUtilVirtualDriveImageMap", "vdrive-map-[virtual_drive]", VersionMeta.Version311c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'storageFlexUtilController'], [], [None]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version311c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageControllerNVMe'], [], [None]),
        ...
        "SystemBoardUnit": MoMeta("SystemBoardUnit", "systemBoardUnit", "sys-board-unit", VersionMeta.Version311c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'topSystem'], [], [None]),
        ...
        "X86LiveDebug": MoMeta("X86LiveDebug", "x86LiveDebug", "live-debug", VersionMeta.Version311c, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeRackUnit'], [], [None]),
    },
