...
class HuuFirmwareRunning(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("HuuFirmwareRunning", "huuFirmwareRunning", "currentFirmware", VersionMeta.Version151f, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'huuController'], [u'huuFirmwareComponent'], ["Get"]),
        "modular": MoMeta("HuuFirmwareRunning", "huuFirmwareRunning", "currentFirmware", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'huuController'], [u'huuFirmwareComponent'], [None])
    }
