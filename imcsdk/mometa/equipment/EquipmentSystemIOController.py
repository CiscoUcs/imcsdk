...
class EquipmentSystemIOController(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("EquipmentSystemIOController", "equipmentSystemIOController", "upload-catalog", VersionMeta.Version2013e, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], [u'equipmentChassis'], [u'commEpIpmiLan', u'equipmentSharedIOModule', u'mgmtController', u'siocResetReason'], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            "admin_power": MoPropertyMeta("admin_power", "adminPower", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["cmc-reboot", "cmc-reset-default", "policy"], []), 
