...
class VersionMeta:
    ...
    Version152 = ImcVersion("1.5(2)")
    Version153 = ImcVersion("1.5(3)")
    Version154 = ImcVersion("1.5(4)")
    ...
    Version413h = ImcVersion("4.1(3h)")
    Version421a = ImcVersion("4.2(1a)")
    Version421b = ImcVersion("4.2(1b)")
    Version422a = ImcVersion("4.2(2a)")
    Version423a = ImcVersion("4.2(3a)")
    Version431a = ImcVersion("4.3(1a)")
    Version432_230190 = ImcVersion("4.3(2.230190)")
    Version432_230285 = ImcVersion("4.3(2.230285)")
    Version433_240024 = ImcVersion("4.3(3.240024)")
    Version434_240077 = ImcVersion("4.3(4.240077)")
    Version435_240037 = ImcVersion("4.3(5.240037)")
    Version435_240045 = ImcVersion("4.3(5.240045)")
...
MO_CLASS_ID = frozenset([
    ...
    "BiosUnit",
    "BiosVfASPMSupport",
    "BiosVfAcpiSratSpFlagEn",
    "BiosVfAdaptiveRefreshMgmtLevel",
    ...
    "BiosVfC1AutoDemotion",
    "BiosVfC1AutoUnDemotion",
    "BiosVfCDNEnable",
    "BiosVfCDNSupport",
    ...
    "BiosVfCRQos",
    "BiosVfCbsCmnApbdis",
    "BiosVfCbsCmnApbdisDfPstateRs",
    "BiosVfCbsCmnCpuAvx512",
    "BiosVfCbsCmnCpuCpb",
    ...
    "BiosVfCbsCmnCpuSevAsidSpaceLimit",
    "BiosVfCbsCmnCpuSmee",
    "BiosVfCbsCmnCpuStreamingStoresCtrl",
    "BiosVfCbsCmnDeterminismSlider",
    "BiosVfCbsCmnEdcControlThrottle",
    "BiosVfCbsCmnEfficiencyModeEn",
    "BiosVfCbsCmnEfficiencyModeEnRs",
    ...
    "BiosVfCbsCmnGnbSMUDlwmSupport",
    "BiosVfCbsCmnMemCtrlBankGroupSwapDdr4",
    "BiosVfCbsCmnMemCtrllerPwrDnEnDdr",
    "BiosVfCbsCmnMemMapBankInterleaveDdr4",
    "BiosVfCbsCmnMemSpeedDdr47xx2",
    "BiosVfCbsCmnMemSpeedDdr47xx3",
    "BiosVfCbsCmnPreferredIO7xx2",
    "BiosVfCbsCmnPreferredIO7xx3",
    "BiosVfCbsCmncTDPCtl",
    "BiosVfCbsCmnxGmiForceLinkWidthRs",
    "BiosVfCbsCpuCcdCtrlSsp",
    "BiosVfCbsCpuCoreCtrl",
    "BiosVfCbsCpuDownCoreCtrlBergamo",
    "BiosVfCbsCpuDownCoreCtrlGenoa",
    "BiosVfCbsCpuSmtCtrl",
    "BiosVfCbsDbgCpuGenCpuWdt",
    "BiosVfCbsDbgCpuLApicMode",
    "BiosVfCbsDbgCpuSnpMemCover",
    "BiosVfCbsDbgCpuSnpMemSizeCover",
    "BiosVfCbsDfCmn4LinkMaxXgmiSpeed",
    "BiosVfCbsDfCmnAcpiSratL3Numa",
    "BiosVfCbsDfCmnDramNps",
    "BiosVfCbsDfCmnDramScrubTime",
    "BiosVfCbsDfCmnMemIntlv",
    "BiosVfCbsDfCmnMemIntlvControl",
    "BiosVfCbsDfCmnMemIntlvSize",
    "BiosVfCbsDfDbgXgmiLinkCfg",
    "BiosVfCbsGnbDbgPcieTbtSupport",
    ...
    "PsuRedundancyPolicy",
    "RackUnitPersonality",
    "SecureBootCACertificateInfo",
    "SecureBootCertificateManagement",
    "SecureLdap",
...
MO_CLASS_META = {
    "classic": {
        ...
        "AdaptorEthSRIOVProfile": MoMeta("AdaptorEthSRIOVProfile", "adaptorEthSRIOVProfile", "eth-sriov", VersionMeta.Version423a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['adaptorHostEthIf'], [], [None]),
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version435_240045, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "BiosUnit": MoMeta("BiosUnit", "biosUnit", "bios", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeRackUnit'], ['biosBOT', 'biosPlatformDefaults', 'biosProfileManagement', 'biosSettings', 'biosf2Password', 'firmwareBootDefinition', 'firmwareRunning', 'firmwareUpdatable', 'secureBootCertificateManagement'], ["Get", "Set"]),
        ...
        "BiosVfAcpiSratSpFlagEn": MoMeta("BiosVfAcpiSratSpFlagEn", "biosVfAcpiSratSpFlagEn", "ACPI-SRAT-Memory-Flag", VersionMeta.Version435_240037, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfAdaptiveRefreshMgmtLevel": MoMeta("BiosVfAdaptiveRefreshMgmtLevel", "biosVfAdaptiveRefreshMgmtLevel", "Adaptive-Refresh-Mgmt-Level", VersionMeta.Version431a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfBurstAndPostponedRefresh": MoMeta("BiosVfBurstAndPostponedRefresh", "biosVfBurstAndPostponedRefresh", "Burst-And-Postponed-Refresh", VersionMeta.Version413h, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfC1AutoDemotion": MoMeta("BiosVfC1AutoDemotion", "biosVfC1AutoDemotion", "C1-Auto-Demotion", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfC1AutoUnDemotion": MoMeta("BiosVfC1AutoUnDemotion", "biosVfC1AutoUnDemotion", "C1-Auto-UnDemotion", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnApbdisDfPstateRs": MoMeta("BiosVfCbsCmnApbdisDfPstateRs", "biosVfCbsCmnApbdisDfPstateRs", "fixed-soc-pstate-F19h", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCmnCpuAvx512": MoMeta("BiosVfCbsCmnCpuAvx512", "biosVfCbsCmnCpuAvx512", "AVX512", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnCpuSevAsidSpaceLimit": MoMeta("BiosVfCbsCmnCpuSevAsidSpaceLimit", "biosVfCbsCmnCpuSevAsidSpaceLimit", "Cpu-Sev-Asid-Space-Limit", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnEdcControlThrottle": MoMeta("BiosVfCbsCmnEdcControlThrottle", "biosVfCbsCmnEdcControlThrottle", "edc-control-throttle", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnEfficiencyModeEnRs": MoMeta("BiosVfCbsCmnEfficiencyModeEnRs", "biosVfCbsCmnEfficiencyModeEnRs", "Efficiency-Mode-En-F19h", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnGnbSMUDffoRs": MoMeta("BiosVfCbsCmnGnbSMUDffoRs", "biosVfCbsCmnGnbSMUDffoRs", "DF_PState_Frequency_Optimizer", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCmnGnbSMUDlwmSupport": MoMeta("BiosVfCbsCmnGnbSMUDlwmSupport", "biosVfCbsCmnGnbSMUDlwmSupport", "dlwm-support", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnMemCtrllerPwrDnEnDdr": MoMeta("BiosVfCbsCmnMemCtrllerPwrDnEnDdr", "biosVfCbsCmnMemCtrllerPwrDnEnDdr", "Power_Down_Enable", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnMemSpeedDdr47xx2": MoMeta("BiosVfCbsCmnMemSpeedDdr47xx2", "biosVfCbsCmnMemSpeedDdr47xx2", "memory-clock-speed-7xx2", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCmnMemSpeedDdr47xx3": MoMeta("BiosVfCbsCmnMemSpeedDdr47xx3", "biosVfCbsCmnMemSpeedDdr47xx3", "memory-clock-speed-7xx3", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCmnPreferredIO7xx2": MoMeta("BiosVfCbsCmnPreferredIO7xx2", "biosVfCbsCmnPreferredIO7xx2", "preferred-io-7xx2", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCmnPreferredIO7xx3": MoMeta("BiosVfCbsCmnPreferredIO7xx3", "biosVfCbsCmnPreferredIO7xx3", "preferred-io-7xx3", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCmnxGmiForceLinkWidthRs": MoMeta("BiosVfCbsCmnxGmiForceLinkWidthRs", "biosVfCbsCmnxGmiForceLinkWidthRs", "xGMI_Force_Link_Width", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsCpuDownCoreCtrlBergamo": MoMeta("BiosVfCbsCpuDownCoreCtrlBergamo", "biosVfCbsCpuDownCoreCtrlBergamo", "downcore-ctrl", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsCpuDownCoreCtrlGenoa": MoMeta("BiosVfCbsCpuDownCoreCtrlGenoa", "biosVfCbsCpuDownCoreCtrlGenoa", "downcore-control", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsDbgCpuGenCpuWdt": MoMeta("BiosVfCbsDbgCpuGenCpuWdt", "biosVfCbsDbgCpuGenCpuWdt", "core-watchdog-timer-enable", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsDbgCpuLApicMode": MoMeta("BiosVfCbsDbgCpuLApicMode", "biosVfCbsDbgCpuLApicMode", "local-apci-mode", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsDfCmn4LinkMaxXgmiSpeed": MoMeta("BiosVfCbsDfCmn4LinkMaxXgmiSpeed", "biosVfCbsDfCmn4LinkMaxXgmiSpeed", "4-link-xGMI-max-speed", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsDfCmnDramScrubTime": MoMeta("BiosVfCbsDfCmnDramScrubTime", "biosVfCbsDfCmnDramScrubTime", "dram-scrub-time", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsDfCmnMemIntlvControl": MoMeta("BiosVfCbsDfCmnMemIntlvControl", "biosVfCbsDfCmnMemIntlvControl", "memory_interleaving", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCbsDfDbgXgmiLinkCfg": MoMeta("BiosVfCbsDfDbgXgmiLinkCfg", "biosVfCbsDfDbgXgmiLinkCfg", "xGMI-link-configuration", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCbsGnbDbgPcieTbtSupport": MoMeta("BiosVfCbsGnbDbgPcieTbtSupport", "biosVfCbsGnbDbgPcieTbtSupport", "pcie-ten-bit-tag-support", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfCpuPaLimit": MoMeta("BiosVfCpuPaLimit", "biosVfCpuPaLimit", "Cpu-Pa-Limit", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfCpuPerfEnhancement": MoMeta("BiosVfCpuPerfEnhancement", "biosVfCpuPerfEnhancement", "Cpu-Perf-Enhancement", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfDfxOsbEn": MoMeta("BiosVfDfxOsbEn", "biosVfDfxOsbEn", "DFX-OSB", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfDmaCtrlOptIn": MoMeta("BiosVfDmaCtrlOptIn", "biosVfDmaCtrlOptIn", "Dma-Control", VersionMeta.Version423a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfEnableRMT": MoMeta("BiosVfEnableRMT", "biosVfEnableRMT", "Rank-Margin-Tool", VersionMeta.Version431a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfEnableTdx": MoMeta("BiosVfEnableTdx", "biosVfEnableTdx", "Trust-Domain-Extension", VersionMeta.Version432_230285, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfEnableTdxSeamldr": MoMeta("BiosVfEnableTdxSeamldr", "biosVfEnableTdxSeamldr", "TDX-Secure-Arbitration-Mode-Loader", VersionMeta.Version432_230285, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfErrorCheckScrub": MoMeta("BiosVfErrorCheckScrub", "biosVfErrorCheckScrub", "Error-Check-Scrub", VersionMeta.Version431a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfIOATConfigCpm": MoMeta("BiosVfIOATConfigCpm", "biosVfIOATConfigCpm", "IOAT Configuration", VersionMeta.Version433_240024, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfLLCAlloc": MoMeta("BiosVfLLCAlloc", "biosVfLLCAlloc", "LLC-Alloc", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfLatencyOptimizedMode": MoMeta("BiosVfLatencyOptimizedMode", "biosVfLatencyOptimizedMode", "Latency-Optimized-Mode", VersionMeta.Version435_240045, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfMmiohBase": MoMeta("BiosVfMmiohBase", "biosVfMmiohBase", "MMIO-High-Base", VersionMeta.Version433_240024, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfMmiohSize": MoMeta("BiosVfMmiohSize", "biosVfMmiohSize", "MMIO-High-Granularity-Size", VersionMeta.Version433_240024, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfOptimizedPowerMode": MoMeta("BiosVfOptimizedPowerMode", "biosVfOptimizedPowerMode", "Optimized-Power-Mode", VersionMeta.Version432_230190, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfPchPciePllSsc": MoMeta("BiosVfPchPciePllSsc", "biosVfPchPciePllSsc", "Pch-PCIe-PLL-SSC", VersionMeta.Version431a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfPcieSlotsCdnEnable": MoMeta("BiosVfPcieSlotsCdnEnable", "biosVfPcieSlotsCdnEnable", "PCIe-Slots-CDN-Control", VersionMeta.Version413h, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfPreBootDMAProtection": MoMeta("BiosVfPreBootDMAProtection", "biosVfPreBootDMAProtection", "PreBootDMAProtection", VersionMeta.Version435_240045, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfPrmrrSize": MoMeta("BiosVfPrmrrSize", "biosVfPrmrrSize", "PRMRR-Size", VersionMeta.Version432_230190, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfResizeBarSupport": MoMeta("BiosVfResizeBarSupport", "biosVfResizeBarSupport", "Re-Size-BAR-Support", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfRuntimePostPackageRepair": MoMeta("BiosVfRuntimePostPackageRepair", "biosVfRuntimePostPackageRepair", "runtime-post-package-repair", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfSHA1PCRBank": MoMeta("BiosVfSHA1PCRBank", "biosVfSHA1PCRBank", "SHA1-PCR-Bank", VersionMeta.Version413h, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfSHA256PCRBank": MoMeta("BiosVfSHA256PCRBank", "biosVfSHA256PCRBank", "SHA256-PCR-Bank", VersionMeta.Version413h, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfSHA384PCRBank": MoMeta("BiosVfSHA384PCRBank", "biosVfSHA384PCRBank", "SHA384-PCR-Bank", VersionMeta.Version432_230285, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfSerialMux": MoMeta("BiosVfSerialMux", "biosVfSerialMux", "serial-mux", VersionMeta.Version434_240077, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfTpmPpiRequired": MoMeta("BiosVfTpmPpiRequired", "biosVfTpmPpiRequired", "Tpm-Ppi-Required", VersionMeta.Version413h, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfTpmSupport": MoMeta("BiosVfTpmSupport", "biosVfTpmSupport", "TPM-Support", VersionMeta.Version423a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfUPILinkEnablement": MoMeta("BiosVfUPILinkEnablement", "biosVfUPILinkEnablement", "UPI-Link-Enablement", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "BiosVfUPIPowerManagement": MoMeta("BiosVfUPIPowerManagement", "biosVfUPIPowerManagement", "UPI-Power-Management", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfUefiMemMapSpFlagEn": MoMeta("BiosVfUefiMemMapSpFlagEn", "biosVfUefiMemMapSpFlagEn", "Special-Purpose-Memory-Flag", VersionMeta.Version435_240037, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfVirtualNuma": MoMeta("BiosVfVirtualNuma", "biosVfVirtualNuma", "Virtual-Numa", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfX2ApicOptOut": MoMeta("BiosVfX2ApicOptOut", "biosVfX2ApicOptOut", "X2APIC-Opt-Out", VersionMeta.Version423a, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        ...
        "BiosVfXPTRemotePrefetch": MoMeta("BiosVfXPTRemotePrefetch", "biosVfXPTRemotePrefetch", "XPT-Remote-Prefetch", VersionMeta.Version421b, "InputOutput", 0x1, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "Biosf2Password": MoMeta("Biosf2Password", "biosf2Password", "bios-f2-password", VersionMeta.Version431a, "InputOutput", 0x1, [], ["admin"], ['biosUnit'], [], [None]),
        ...
        "CommSvcEp": MoMeta("CommSvcEp", "commSvcEp", "svc-ext", VersionMeta.Version151f, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['commHttp', 'commHttps', 'commIpmiLan', 'commKvm', 'commMailAlert', 'commNtpProvider', 'commRedfish', 'commSnmp', 'commSsh', 'commSyslog', 'commTlsConfig', 'commVMedia'], ["Get"]),
        "CommSyslog": MoMeta("CommSyslog", "commSyslog", "syslog", VersionMeta.Version151f, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['commSvcEp'], ['commSyslogClient', 'deleteRsyslogCACertificate', 'enableSecuredRsyslog', 'uploadRsyslogCACertificate'], ["Get", "Set"]),
        ...
        "CommTlsConfig": MoMeta("CommTlsConfig", "commTlsConfig", "tls-svc", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['commSvcEp'], [], [None]),
        ...
        "DeleteRsyslogCACertificate": MoMeta("DeleteRsyslogCACertificate", "deleteRsyslogCACertificate", "delete-rsyslog-ca-cert", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['commSyslog'], [], [None]),
        "DeleteSecureBootCertificate": MoMeta("DeleteSecureBootCertificate", "deleteSecureBootCertificate", "delete-secure-boot-cert", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['secureBootCertificateManagement'], [], [None]),
        ...
        "EnableSecuredRsyslog": MoMeta("EnableSecuredRsyslog", "enableSecuredRsyslog", "enableSecuredRsyslog", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['commSyslog'], [], [None]),
        ...
        "NiosInstall": MoMeta("NiosInstall", "niosInstall", "niosinstall", VersionMeta.Version423a, "InputOutput", 0x1, [], ["admin"], ['osiController'], [], [None]),
        "NvmeHybridSlotConfig": MoMeta("NvmeHybridSlotConfig", "nvmeHybridSlotConfig", "nvmeHybridSlotConfig", VersionMeta.Version432_230190, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['topSystem'], ['slotConfig'], [None]),
        ...
        "OsiController": MoMeta("OsiController", "osiController", "osi", VersionMeta.Version301c, "OutputOnly", 0x1, [], ["read-only"], ['topSystem'], ['niosInstall', 'osiCancel', 'osiStart', 'osiStatus'], ["Get"]),
        ...
        "PackagePowerLimit": MoMeta("PackagePowerLimit", "packagePowerLimit", "power-limit", VersionMeta.Version435_240037, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['computeBoard'], [], [None]),
        "PciAdapterFruInventory": MoMeta("PciAdapterFruInventory", "pciAdapterFruInventory", "pci-adapter-fru-[id]", VersionMeta.Version422a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['computeRackUnit'], ['pciAdapterFruInventoryInfo', 'pciAdapterPortStatus', 'pciAdapterTemperature'], [None]),
        "PciAdapterFruInventoryInfo": MoMeta("PciAdapterFruInventoryInfo", "pciAdapterFruInventoryInfo", "fru-info-inv-[id]", VersionMeta.Version422a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['pciAdapterFruInventory'], [], [None]),
        "PciAdapterPortStatus": MoMeta("PciAdapterPortStatus", "pciAdapterPortStatus", "pci-adapter-portstatus-[id]", VersionMeta.Version433_240024, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['pciAdapterFruInventory'], ['faultInst'], [None]),
        "PciAdapterTemperature": MoMeta("PciAdapterTemperature", "pciAdapterTemperature", "pci-adapter-temperature-[id]", VersionMeta.Version433_240024, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['pciAdapterFruInventory'], [], [None]),
        ...
        "SecureBootCACertificateInfo": MoMeta("SecureBootCACertificateInfo", "secureBootCACertificateInfo", "secure-boot-cert-info-", VersionMeta.Version422a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['secureBootCertificateManagement'], [], [None]),
        "SecureBootCertificateManagement": MoMeta("SecureBootCertificateManagement", "secureBootCertificateManagement", "secure-boot-cert-mgmt", VersionMeta.Version422a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], ['biosUnit'], ['deleteSecureBootCertificate', 'secureBootCACertificateInfo', 'uploadSecureBootCertificate'], [None]),
        ...
        "SlotConfig": MoMeta("SlotConfig", "slotConfig", "slot-config-[slot]", VersionMeta.Version432_230190, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['nvmeHybridSlotConfig'], [], [None]),
        ...
        "UploadRsyslogCACertificate": MoMeta("UploadRsyslogCACertificate", "uploadRsyslogCACertificate", "upload-rsyslog-ca-cert", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['commSyslog'], [], [None]),
        "UploadSecureBootCertificate": MoMeta("UploadSecureBootCertificate", "uploadSecureBootCertificate", "upload-secure-boot-cert", VersionMeta.Version422a, "InputOutput", 0x1, [], ["admin", "read-only", "user"], ['secureBootCertificateManagement'], [], [None]),
