...
class IodController(ManagedObject):
    ...
    mo_meta = MoMeta("IodController", "iodController", "iod", VersionMeta.Version151x, "OutputOnly", 0xf, [], ["read-only"], [u'topSystem'], [u'iodSnapshotCancel', u'iodSnapshotStart', u'iodSnapshotStatus'], ["Get"])
