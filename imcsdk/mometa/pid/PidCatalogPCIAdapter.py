...
class PidCatalogPCIAdapter(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("PidCatalogPCIAdapter", "pidCatalogPCIAdapter", "pid-pciadapter-[slot]", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'pidCatalog'], [], [None])
    }
