...
class BiosVfPanicHighWatermark(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfPanicHighWatermark", "biosVfPanicHighWatermark", "Panic-and-High-Watermark", VersionMeta.Version412a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfPanicHighWatermark", "biosVfPanicHighWatermark", "Panic-and-High-Watermark", VersionMeta.Version412a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_panic_high_watermark": MoPropertyMeta("vp_panic_high_watermark", "vpPanicHighWatermark", "string", VersionMeta.Version412a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["High", "Low", "platform-default"], []),
