...
class StorageNVMePhysicalDrive(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageControllerNVMe'], ['faultInst'], ["Get"]),
        "modular": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageControllerNVMe'], ['faultInst'], ["Get"])
    }
