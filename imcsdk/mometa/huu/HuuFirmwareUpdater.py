...
class HuuFirmwareUpdater(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("HuuFirmwareUpdater", "huuFirmwareUpdater", "firmwareUpdater", VersionMeta.Version151f, "InputOutput", 0xfffff, [], ["admin", "read-only", "user"], [u'huuController'], [], ["Get"]),
        "modular": MoMeta("HuuFirmwareUpdater", "huuFirmwareUpdater", "firmwareUpdater", VersionMeta.Version2013e, "InputOutput", 0xfffff, [], ["admin", "read-only", "user"], [u'huuController'], [], ["Get"])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "stop_on_error": MoPropertyMeta("stop_on_error", "stopOnError", "string", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x2000, None, None, None, ["No", "Yes", "false", "no", "true", "yes"], []), 
            "time_out": MoPropertyMeta("time_out", "timeOut", "uint", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x4000, None, None, None, [], ["30-240"]), 
            "update_component": MoPropertyMeta("update_component", "updateComponent", "string", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x8000, None, None, None, [], []), 
            "update_type": MoPropertyMeta("update_type", "updateType", "string", VersionMeta.Version303a, MoPropertyMeta.READ_WRITE, 0x10000, 0, 510, None, ["delay", "delay_reboot", "immediate"], []), 
            "username": MoPropertyMeta("username", "username", "string", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x20000, None, None, None, [], []), 
            "verify_update": MoPropertyMeta("verify_update", "verifyUpdate", "string", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x40000, None, None, None, ["No", "Yes", "false", "no", "true", "yes"], []), 
            "boot_medium": MoPropertyMeta("boot_medium", "bootMedium", "string", VersionMeta.Version304a, MoPropertyMeta.READ_WRITE, 0x80000, 0, 510, None, ["microsd", "pxeboot", "sd", "vmedia"], []), 
        ...
        "modular": {
            ...
            "do_force_down": MoPropertyMeta("do_force_down", "doForceDown", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["no", "yes"], []), 
            "graceful_timeout": MoPropertyMeta("graceful_timeout", "gracefulTimeout", "uint", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, [], ["0-60"]), 
            ...
            "stop_on_error": MoPropertyMeta("stop_on_error", "stopOnError", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x2000, None, None, None, ["No", "Yes", "no", "yes"], []), 
            "time_out": MoPropertyMeta("time_out", "timeOut", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x4000, None, None, None, [], ["30-240"]), 
            "update_component": MoPropertyMeta("update_component", "updateComponent", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x8000, None, None, None, [], []), 
            "update_type": MoPropertyMeta("update_type", "updateType", "string", VersionMeta.Version303a, MoPropertyMeta.READ_WRITE, 0x10000, 0, 510, None, ["delay", "delay_reboot", "immediate"], []), 
            ...
            "verify_update": MoPropertyMeta("verify_update", "verifyUpdate", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x40000, None, None, None, ["No", "Yes", "no", "yes"], []), 
            "child_action": MoPropertyMeta("child_action", "childAction", "string", VersionMeta.Version2013e, MoPropertyMeta.INTERNAL, None, None, None, None, [], []), 
            "cmc_secure_boot": MoPropertyMeta("cmc_secure_boot", "cmcSecureBoot", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x80000, None, None, None, ["No", "Yes", "no", "yes"], []), 
