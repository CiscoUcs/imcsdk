...
class BiosVfCbsCmnCpuCpb(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfCbsCmnCpuCpb", "biosVfCbsCmnCpuCpb", "cpu-cpb", VersionMeta.Version401a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
    }
