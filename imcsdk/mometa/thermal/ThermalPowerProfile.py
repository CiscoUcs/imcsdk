...
class ThermalPowerProfile(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("ThermalPowerProfile", "thermalPowerProfile", "thermal-prof", VersionMeta.Version2013e, "InputOutput", 0x3f, [], ["admin", "read-only", "user"], [u'powerBudget'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "temperature": MoPropertyMeta("temperature", "temperature", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 0, 510, None, [], ["0-4294967295"]), 
        },
