...
class VicImporterAll(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("VicImporterAll", "vicImporterAll", "vic-all-importconfig", VersionMeta.Version303a, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], ['topSystem'], [], ["Get", "Set"]),
        "modular": MoMeta("VicImporterAll", "vicImporterAll", "vic-all-importconfig", VersionMeta.Version303a, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], ['equipmentChassis'], [], ["Get", "Set"])
    }
