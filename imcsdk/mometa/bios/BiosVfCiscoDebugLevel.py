...
class BiosVfCiscoDebugLevel(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfCiscoDebugLevel", "biosVfCiscoDebugLevel", "Cisco-Debug-Level", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
