...
class MgmtImporter(ManagedObject):
    ...
    mo_meta = MoMeta("MgmtImporter", "mgmtImporter", "import-config", VersionMeta.Version151f, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [u'topSystem'], [], [None])
    ...
    prop_meta = {
        ...
        "passphrase": MoPropertyMeta("passphrase", "passphrase", "string", VersionMeta.Version201a, MoPropertyMeta.READ_WRITE, 0x10, 0, 256, None, [], []), 
