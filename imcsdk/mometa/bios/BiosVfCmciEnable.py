...
class BiosVfCmciEnable(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfCmciEnable", "biosVfCmciEnable", "Cmci-Enable", VersionMeta.Version2013e, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vp_cmci_enable": MoPropertyMeta("vp_cmci_enable", "vpCmciEnable", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x20, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
        },
