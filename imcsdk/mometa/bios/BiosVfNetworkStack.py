...
class BiosVfNetworkStack(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfNetworkStack", "biosVfNetworkStack", "Network-Stack", VersionMeta.Version410a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
