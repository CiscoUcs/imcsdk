...
class BiosVfAcpiSratSpFlagEn(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfAcpiSratSpFlagEn", "biosVfAcpiSratSpFlagEn", "ACPI-SRAT-Memory-Flag", VersionMeta.Version435_240037, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_acpi_srat_sp_flag_en": MoPropertyMeta("vp_acpi_srat_sp_flag_en", "vpAcpiSratSpFlagEn", "string", VersionMeta.Version435_240037, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []),
        },
