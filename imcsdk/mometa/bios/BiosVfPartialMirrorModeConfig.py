...
class BiosVfPartialMirrorModeConfig(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfPartialMirrorModeConfig", "biosVfPartialMirrorModeConfig", "Partial-Mirror-Mode", VersionMeta.Version410a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfPartialMirrorModeConfig", "biosVfPartialMirrorModeConfig", "Partial-Mirror-Mode", VersionMeta.Version410a, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_partial_mirror_mode_config": MoPropertyMeta("vp_partial_mirror_mode_config", "vpPartialMirrorModeConfig", "string", VersionMeta.Version410a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Percentage", "Value in GB", "disabled", "platform-default"], []), 
