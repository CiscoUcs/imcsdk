...
class BiosVfTXTSupport(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosVfTXTSupport", "biosVfTXTSupport", "TXT-Support", VersionMeta.Version313a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vp_txt_support": MoPropertyMeta("vp_txt_support", "vpTXTSupport", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
        },
