...
class UploadPIDCatalog(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("UploadPIDCatalog", "uploadPIDCatalog", "upload-catalog", VersionMeta.Version2013e, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['pidCatalog'], [], ["Get"]),
        "modular": MoMeta("UploadPIDCatalog", "uploadPIDCatalog", "upload-catalog", VersionMeta.Version2013e, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['chassisPIDCatalog'], [], ["Get"])
    }
