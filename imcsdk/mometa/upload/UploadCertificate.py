...
class UploadCertificate(ManagedObject):
    ...
    mo_meta = MoMeta("UploadCertificate", "uploadCertificate", "upload-cert", VersionMeta.Version209c, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [u'certificateManagement'], [], [None])
