...
class BiosVfCiscoOpromLaunchOptimization(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfCiscoOpromLaunchOptimization", "biosVfCiscoOpromLaunchOptimization", "Cisco-Opromlaunch-Optimize", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfCiscoOpromLaunchOptimization", "biosVfCiscoOpromLaunchOptimization", "Cisco-Opromlaunch-Optimize", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
