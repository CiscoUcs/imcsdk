...
class AdaptorGenProfile(ManagedObject):
    ...
    mo_meta = MoMeta("AdaptorGenProfile", "adaptorGenProfile", "general", VersionMeta.Version151f, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], [u'adaptorUnit'], [], ["Get", "Set"])
    ...
    prop_meta = {
        ...
        "num_of_vm_fex_ifs": MoPropertyMeta("num_of_vm_fex_ifs", "numOfVMFexIfs", "uint", VersionMeta.Version151f, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, [], ["0-112"]), 
        ...
        "usnic_supported": MoPropertyMeta("usnic_supported", "usnicSupported", "string", VersionMeta.Version152, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
