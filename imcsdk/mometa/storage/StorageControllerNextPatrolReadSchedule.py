...
class StorageControllerNextPatrolReadSchedule(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageController'], [], [None]),
        "modular": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['storageController'], [], [None])
    }
