...
class CommSvcRack(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("CommSvcRack", "commSvcRack", "svc-ext", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ['computeServerNode'], ['commIpmiLan', 'commKvm', 'commVMedia'], ["Get"])
    }
