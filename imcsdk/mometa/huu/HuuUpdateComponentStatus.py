...
class HuuUpdateComponentStatus(ManagedObject):
    ...
    mo_meta = MoMeta("HuuUpdateComponentStatus", "huuUpdateComponentStatus", "component-[component]", VersionMeta.Version151f, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'huuFirmwareUpdateStatus'], [], ["Get"])
