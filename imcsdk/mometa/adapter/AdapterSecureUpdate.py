...
class AdapterSecureUpdate(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("AdapterSecureUpdate", "adapterSecureUpdate", "adapter-secure-update", VersionMeta.Version313h, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], [u'computeServerNode'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "secure_update": MoPropertyMeta("secure_update", "secureUpdate", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []), 
