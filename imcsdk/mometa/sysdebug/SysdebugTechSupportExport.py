...
class SysdebugTechSupportExport(ManagedObject):
    ...
    mo_meta = MoMeta("SysdebugTechSupportExport", "sysdebugTechSupportExport", "tech-support", VersionMeta.Version151f, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], [u'computeRackUnit'], [], [None])
