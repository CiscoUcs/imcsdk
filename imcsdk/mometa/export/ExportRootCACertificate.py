"""This module contains the general information for ExportRootCACertificate ManagedObject."""
...
class ExportRootCACertificateConsts:
    PROTOCOL_FTP = "ftp"
    PROTOCOL_HTTP = "http"
    PROTOCOL_NONE = "none"
    PROTOCOL_SCP = "scp"
...
class ExportRootCACertificate(ManagedObject):
    """This is ExportRootCACertificate class."""

    consts = ExportRootCACertificateConsts()
    naming_props = set([])

    mo_meta = {
        "classic": MoMeta("ExportRootCACertificate", "exportRootCACertificate", "kmip-ca-cert-export", VersionMeta.Version302b, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None]),
        "modular": MoMeta("ExportRootCACertificate", "exportRootCACertificate", "kmip-ca-cert-export", VersionMeta.Version303a, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ['kmipManagement'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version302b, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[^\(\)~`'\?\\"";<>\|&\*\^$%]{1,255}""", [], []),
        ...
        "modular": {
            ...
            "remote_file": MoPropertyMeta("remote_file", "remoteFile", "string", VersionMeta.Version303a, MoPropertyMeta.READ_WRITE, 0x10, None, None, r"""[^\(\)~`'\?\\"";<>\|&\*\^$%]{1,255}""", [], []),
            "remote_server": MoPropertyMeta("remote_server", "remoteServer", "string", VersionMeta.Version303a, MoPropertyMeta.READ_WRITE, 0x20, 0, 255, r"""(([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6})|(([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?)+)|(https?://)?([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])""", [], []),
    ...
    def __init__(self, parent_mo_or_dn, **kwargs):
        ...
        ManagedObject.__init__(self, "ExportRootCACertificate", parent_mo_or_dn, **kwargs)
