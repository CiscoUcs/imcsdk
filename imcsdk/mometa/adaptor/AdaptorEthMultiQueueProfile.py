...
class AdaptorEthMultiQueueProfile(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("AdaptorEthMultiQueueProfile", "adaptorEthMultiQueueProfile", "eth-multi-q", VersionMeta.Version402c, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ['adaptorHostEthIf'], [], [None])
    }
