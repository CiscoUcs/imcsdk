...
class BiosVfLLCPrefetch(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version311a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [" SET", "GET"]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_llc_prefetch": MoPropertyMeta("vp_llc_prefetch", "vpLLCPrefetch", "string", VersionMeta.Version311a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
        },
