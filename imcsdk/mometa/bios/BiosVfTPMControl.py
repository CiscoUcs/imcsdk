...
class BiosVfTPMControl(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version311a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [" SET", "GET"]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_tpm_control": MoPropertyMeta("vp_tpm_control", "vpTPMControl", "string", VersionMeta.Version311a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
        },
