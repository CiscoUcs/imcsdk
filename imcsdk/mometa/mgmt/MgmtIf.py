...
class MgmtIf(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "vic_slot": MoPropertyMeta("vic_slot", "vicSlot", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x10000000, None, None, None, ["0", "1", "10", "2", "4", "5", "9", "flex-lom", "riser1", "riser2"], []), 
