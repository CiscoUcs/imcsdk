...
MO_CLASS_META = {
    "classic": {
        ...
        "BiosPassword": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version304a, "InputOutput", 0x1, [], ["admin"], [], [], [None]),
        ...
        "PsuRedundancyPolicy": MoMeta("PsuRedundancyPolicy", "psuRedundancyPolicy", "psu-redundancy-policy", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [], [None]),
        ...
        "StorageControllerNVMe": MoMeta("StorageControllerNVMe", "storageControllerNVMe", "storage-NVMe-[id]", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'firmwareRunning', u'storageNVMePhysicalDrive'], ["Get"]),
        "StorageControllerNextConsistencyCheckSchedule": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "StorageControllerNextPatrolReadSchedule": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version401a, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageControllerNVMe'], [], ["Get"]),
    ...
    "modular": {
        ...
        "BiosVfAutoCCState": MoMeta("BiosVfAutoCCState", "biosVfAutoCCState", "auto-cc-state", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfBmeDmaMitigation": MoMeta("BiosVfBmeDmaMitigation", "biosVfBmeDmaMitigation", "bme-dma-mitigation", VersionMeta.Version401c, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfEPPProfile": MoMeta("BiosVfEPPProfile", "biosVfEPPProfile", "epp-profile", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "BiosVfEnergyEfficientTurbo": MoMeta("BiosVfEnergyEfficientTurbo", "biosVfEnergyEfficientTurbo", "energy-efficient-turbo", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfIMCInterleave": MoMeta("BiosVfIMCInterleave", "biosVfIMCInterleave", "imc-interleave", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfIPV6PXE": MoMeta("BiosVfIPV6PXE", "biosVfIPV6PXE", "IPv6-Pxe", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfKTIPrefetch": MoMeta("BiosVfKTIPrefetch", "biosVfKTIPrefetch", "kti-prefetch", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfLLCPrefetch": MoMeta("BiosVfLLCPrefetch", "biosVfLLCPrefetch", "LLC-Prefetch", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfPSata": MoMeta("BiosVfPSata", "biosVfPSata", "PSata", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfSubNumaClustering": MoMeta("BiosVfSubNumaClustering", "biosVfSubNumaClustering", "sub-numa-cluster", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        "BiosVfTPMControl": MoMeta("BiosVfTPMControl", "biosVfTPMControl", "TPM-Control", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "BiosVfTXTSupport": MoMeta("BiosVfTXTSupport", "biosVfTXTSupport", "TXT-Support", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        ...
        "BiosVfXPTPrefetch": MoMeta("BiosVfXPTPrefetch", "biosVfXPTPrefetch", "xpt-prefetch", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], ["Get", "Set"]),
        ...
        "CommSnmpConfigCommit": MoMeta("CommSnmpConfigCommit", "commSnmpConfigCommit", "snmp-config-commit", VersionMeta.Version401c, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'commSnmp'], [], [None]),
        ...
        "StorageControllerHealth": MoMeta("StorageControllerHealth", "storageControllerHealth", "controller-health", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], ["Get"]),
        "StorageControllerNVMe": MoMeta("StorageControllerNVMe", "storageControllerNVMe", "storage-NVMe-[id]", VersionMeta.Version2013e, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'computeBoard'], [u'firmwareRunning', u'storageNVMePhysicalDrive'], ["Get"]),
        "StorageControllerNextConsistencyCheckSchedule": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313h, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "StorageControllerNextPatrolReadSchedule": MoMeta("StorageControllerNextPatrolReadSchedule", "storageControllerNextPatrolReadSchedule", "patrol-read", VersionMeta.Version313h, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        ...
        "StorageNVMePhysicalDrive": MoMeta("StorageNVMePhysicalDrive", "storageNVMePhysicalDrive", "pd-[id]", VersionMeta.Version313h, "OutputOnly", 0x1, [], ["admin", "read-only", "user"], [u'storageControllerNVMe'], [], ["Get"]),
        ...
        "AdapterSecureUpdate": MoMeta("AdapterSecureUpdate", "adapterSecureUpdate", "adapter-secure-update", VersionMeta.Version313h, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'computeServerNode'], [], [None]),
        ...
        "EquipmentSystemIOController": MoMeta("EquipmentSystemIOController", "equipmentSystemIOController", "slot-[id]", VersionMeta.Version2013e, "InputOutput", 0x1, [], ["admin", "read-only", "user"], [u'equipmentChassis'], [u'commEpIpmiLan', u'equipmentSharedIOModule', u'faultInst', u'mgmtController', u'siocResetReason'], ["Get", "Set"]),
