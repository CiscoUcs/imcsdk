...
class BiosVfKTIPrefetch(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfKTIPrefetch", "biosVfKTIPrefetch", "kti-prefetch", VersionMeta.Version311a, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [" SET", "GET"]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_kti_prefetch": MoPropertyMeta("vp_kti_prefetch", "vpKTIPrefetch", "string", VersionMeta.Version311a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []), 
        },
