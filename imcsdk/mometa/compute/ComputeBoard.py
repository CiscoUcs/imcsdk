...
class ComputeBoard(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("ComputeBoard", "computeBoard", "board", VersionMeta.Version151f, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'computeRackUnit'], [u'biosVfResumeOnACPowerLoss', u'computeMbPowerStats', u'computeRackUnitMbTempStats', u'equipmentTpm', u'fanPolicy', u'faultInst', u'graphicsCard', u'memoryArray', u'memoryPersistentMemoryConfiguration', u'memoryPersistentMemoryLogicalConfiguration', u'pciSwitch', u'pidCatalog', u'processorUnit', u'psuRedundancyPolicy', u'storageController', u'storageControllerNVMe', u'storageFlexFlashController', u'storageFlexUtilController', u'storageLocalDiskSlotEp'], ["Get"]),
        "modular": MoMeta("ComputeBoard", "computeBoard", "board", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'computeServerNode'], [u'biosVfResumeOnACPowerLoss', u'computeMbPowerStats', u'computeServerNodeMbTempStats', u'equipmentTpm', u'faultInst', u'memoryArray', u'memoryPersistentMemoryConfiguration', u'memoryPersistentMemoryLogicalConfiguration', u'pidCatalog', u'processorUnit', u'storageController', u'storageControllerNVMe', u'storageFlexFlashController', u'storageLocalDiskSlotEp'], ["Get"])
    }
