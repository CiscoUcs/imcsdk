...
class HuuFirmwareUpdater(ManagedObject):
    ...
    mo_meta = MoMeta("HuuFirmwareUpdater", "huuFirmwareUpdater", "firmwareUpdater", VersionMeta.Version151f, "InputOutput", 0xffff, [], ["admin", "read-only", "user"], [u'huuController'], [], ["Get"])
