...
class BiosVfIntelSpeedSelectConsts:
    VP_INTEL_SPEED_SELECT_AUTO = "Auto"
    ...
    VP_INTEL_SPEED_SELECT_LEVEL_0 = "Level 0"
    VP_INTEL_SPEED_SELECT_LEVEL_1 = "Level 1"
    VP_INTEL_SPEED_SELECT_LEVEL_2 = "Level 2"
    VP_INTEL_SPEED_SELECT_LEVEL_3 = "Level 3"
    VP_INTEL_SPEED_SELECT_LEVEL_4 = "Level 4"
...
class BiosVfIntelSpeedSelect(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_intel_speed_select": MoPropertyMeta("vp_intel_speed_select", "vpIntelSpeedSelect", "string", VersionMeta.Version404b, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Auto", "Base", "Config 1", "Config 2", "Config 3", "Config 4", "Level 0", "Level 1", "Level 2", "Level 3", "Level 4", "platform-default"], []),
