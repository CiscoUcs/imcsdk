...
class TopSystem(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("TopSystem", "topSystem", "sys", VersionMeta.Version151f, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], [u'topRoot'], [u'aaaLdap', u'aaaUserEp', u'certificateManagement', u'cloudMgmtSvc', u'commSvcEp', u'computeRackUnit', u'equipmentRackEnclosure', u'huuController', u'iodController', u'kmipManagement', u'mgmtBackup', u'mgmtImporter', u'mgmtInventory', u'osiController', u'storageSasExpander', u'systemBoardUnit', u'vicBackupAll', u'vicImporterAll'], ["Get", "Set"]),
        "modular": MoMeta("TopSystem", "topSystem", "sys", VersionMeta.Version2013e, "InputOutput", 0xff, [], ["admin", "read-only", "user"], [u'topRoot'], [u'aaaLdap', u'aaaUserEp', u'certificateManagement', u'cloudMgmtSvc', u'commSvcEp', u'equipmentChassis', u'sysdebugTechSupportExport'], ["Get", "Set"])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "fips_enable": MoPropertyMeta("fips_enable", "fipsEnable", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x8, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []), 
