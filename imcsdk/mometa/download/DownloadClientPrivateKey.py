...
class DownloadClientPrivateKey(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("DownloadClientPrivateKey", "downloadClientPrivateKey", "kmip-private-key-download", VersionMeta.Version302b, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [u'kmipManagement'], [], [None]),
        "modular": MoMeta("DownloadClientPrivateKey", "downloadClientPrivateKey", "kmip-private-key-download", VersionMeta.Version303a, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [u'kmipManagement'], [], [None])
    }
