...
class LsbootPxe(ManagedObject):
    ...
    prop_meta = {
        ...
        "modular": {
            ...
            "iptype": MoPropertyMeta("iptype", "iptype", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x4, None, None, None, ["", "IPv4", "IPv6"], []), 
            "mac_address": MoPropertyMeta("mac_address", "macAddress", "string", VersionMeta.Version313h, MoPropertyMeta.READ_WRITE, 0x8, None, None, r"""(([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F]))|0""", [""], []), 
