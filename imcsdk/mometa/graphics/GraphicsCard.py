...
class GraphicsCard(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("GraphicsCard", "graphicsCard", "graphics-card-[id]", VersionMeta.Version402c, "OutputOnly", 0xf, [], ["read-only"], [u'computeBoard'], [], [None]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version402c, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
