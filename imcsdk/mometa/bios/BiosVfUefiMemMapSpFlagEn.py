...
class BiosVfUefiMemMapSpFlagEn(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfUefiMemMapSpFlagEn", "biosVfUefiMemMapSpFlagEn", "Special-Purpose-Memory-Flag", VersionMeta.Version435_241008, "InputOutput", 0x1f, [], ["admin"], ['biosPlatformDefaults', 'biosSettings'], [], [None]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "vp_uefi_mem_map_sp_flag_en": MoPropertyMeta("vp_uefi_mem_map_sp_flag_en", "vpUefiMemMapSpFlagEn", "string", VersionMeta.Version435_241008, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled", "platform-default"], []),
        },
