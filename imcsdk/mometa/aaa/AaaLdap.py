...
class AaaLdap(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "dns_search_domain": MoPropertyMeta("dns_search_domain", "dnsSearchDomain", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x100, 0, 64, r"""[a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]""", [], []), 
            "dns_search_forest": MoPropertyMeta("dns_search_forest", "dnsSearchForest", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x200, 0, 64, r"""[a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]""", [], []), 
            "domain": MoPropertyMeta("domain", "domain", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x400, 1, 255, None, [], []), 
            ...
            "filter": MoPropertyMeta("filter", "filter", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x1000, 0, 20, r"""([a-zA-Z0-9][a-zA-Z0-9_#@$%&\-\^]*[a-zA-Z0-9\-]){0,20}""", [], []), 
            ...
            "ldap_server1": MoPropertyMeta("ldap_server1", "ldapServer1", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x8000, 0, 255, r"""(([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:) |((([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6})|(([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?)+)|([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))""", [""], []), 
            ...
            "ldap_server_port1": MoPropertyMeta("ldap_server_port1", "ldapServerPort1", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x200000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port2": MoPropertyMeta("ldap_server_port2", "ldapServerPort2", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x400000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port3": MoPropertyMeta("ldap_server_port3", "ldapServerPort3", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x800000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port4": MoPropertyMeta("ldap_server_port4", "ldapServerPort4", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x1000000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port5": MoPropertyMeta("ldap_server_port5", "ldapServerPort5", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x2000000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port6": MoPropertyMeta("ldap_server_port6", "ldapServerPort6", "uint", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x4000000, None, None, None, [], ["1-65535"]), 
            "locate_directory_using_dns": MoPropertyMeta("locate_directory_using_dns", "locateDirectoryUsingDNS", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x8000000, None, None, None, ["No", "Yes", "false", "no", "true", "yes"], []), 
            "password": MoPropertyMeta("password", "password", "string", VersionMeta.Version151x, MoPropertyMeta.READ_WRITE, 0x10000000, None, None, r"""[\S+]{0,254}""", [], []), 
        ...
        "modular": {
            ...
            "attribute": MoPropertyMeta("attribute", "attribute", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x4, 0, 64, r"""[a-zA-Z0-9][a-zA-Z0-9\-\.]*[a-zA-Z0-9\-]""", [], []), 
            ...
            "dns_search_domain": MoPropertyMeta("dns_search_domain", "dnsSearchDomain", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x100, 0, 63, r"""([a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]){0,63}""", [], []), 
            "dns_search_forest": MoPropertyMeta("dns_search_forest", "dnsSearchForest", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200, 0, 63, r"""([a-zA-Z][a-zA-Z0-9\.\-]*[a-zA-Z0-9]){0,63}""", [], []), 
            "domain": MoPropertyMeta("domain", "domain", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x400, 1, 255, None, [], []), 
            ...
            "filter": MoPropertyMeta("filter", "filter", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x1000, 0, 20, r"""([a-zA-Z0-9][a-zA-Z0-9_#@$%&\-\^]*[a-zA-Z0-9\-]){0,20}""", [], []), 
            ...
            "ldap_server1": MoPropertyMeta("ldap_server1", "ldapServer1", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x8000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server2": MoPropertyMeta("ldap_server2", "ldapServer2", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x10000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server3": MoPropertyMeta("ldap_server3", "ldapServer3", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x20000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server4": MoPropertyMeta("ldap_server4", "ldapServer4", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x40000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server5": MoPropertyMeta("ldap_server5", "ldapServer5", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x80000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server6": MoPropertyMeta("ldap_server6", "ldapServer6", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x100000, 0, 255, r"""([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:([0-9A-Fa-f]{1,4}:[0-9A-Fa-f]{0,4}|:[0-9A-Fa-f]{1,4})?|(:[0-9A-Fa-f]{1,4}){0,2})|(:[0-9A-Fa-f]{1,4}){0,3})|(:[0-9A-Fa-f]{1,4}){0,4})|:(:[0-9A-Fa-f]{1,4}){0,5})((:[0-9A-Fa-f]{1,4}){2}|:(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])(\.(25[0-5]|(2[0-4]|1[0-9]|[1-9])?[0-9])){3})|(([0-9A-Fa-f]{1,4}:){1,6}|:):[0-9A-Fa-f]{0,4}|([0-9A-Fa-f]{1,4}:){7}:""", [""], []), 
            "ldap_server_port1": MoPropertyMeta("ldap_server_port1", "ldapServerPort1", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x200000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port2": MoPropertyMeta("ldap_server_port2", "ldapServerPort2", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x400000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port3": MoPropertyMeta("ldap_server_port3", "ldapServerPort3", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x800000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port4": MoPropertyMeta("ldap_server_port4", "ldapServerPort4", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x1000000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port5": MoPropertyMeta("ldap_server_port5", "ldapServerPort5", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x2000000, None, None, None, [], ["1-65535"]), 
            "ldap_server_port6": MoPropertyMeta("ldap_server_port6", "ldapServerPort6", "uint", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x4000000, None, None, None, [], ["1-65535"]), 
            "locate_directory_using_dns": MoPropertyMeta("locate_directory_using_dns", "locateDirectoryUsingDNS", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x8000000, None, None, None, ["No", "Yes", "no", "yes"], []), 
            "password": MoPropertyMeta("password", "password", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_WRITE, 0x10000000, None, None, r"""[\S+]{0,254}""", [], []), 
