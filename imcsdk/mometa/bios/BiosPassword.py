...
class BiosPassword(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosPassword", "biosPassword", "bios-pw", VersionMeta.Version311a, "InputOutput", 0x1f, [], ["admin"], [], [], [None]),
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "password": MoPropertyMeta("password", "password", "string", VersionMeta.Version311a, MoPropertyMeta.READ_WRITE, 0x4, None, None, r"""[\S+]{0,20}""", [], []), 
