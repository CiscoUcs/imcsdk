...
class BiosVfCiscoAdaptiveMemTraining(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("BiosVfCiscoAdaptiveMemTraining", "biosVfCiscoAdaptiveMemTraining", "Cisco-Adap-Mem", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None]),
        "modular": MoMeta("BiosVfCiscoAdaptiveMemTraining", "biosVfCiscoAdaptiveMemTraining", "Cisco-Adap-Mem", VersionMeta.Version402c, "InputOutput", 0x1f, [], ["admin"], [u'biosPlatformDefaults', u'biosSettings'], [], [None])
    }
