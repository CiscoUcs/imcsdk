...
class BiosBOT(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("BiosBOT", "biosBOT", "bdgep", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'biosUnit'], [u'biosBootDevGrp', u'biosBootDevPrecision', u'biosBootMode'], [None])
    }
