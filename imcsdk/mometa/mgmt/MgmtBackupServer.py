...
class MgmtBackupServer(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("MgmtBackupServer", "mgmtBackupServer", "exporter-config", VersionMeta.Version2013e, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ['computeServerNode'], [], ["Get", "Set"])
    }
