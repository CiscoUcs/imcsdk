...
class StorageControllerNextConsistencyCheckSchedule(ManagedObject):
    ...
    mo_meta = {
        "classic": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version401a, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageController'], [], [None]),
        "modular": MoMeta("StorageControllerNextConsistencyCheckSchedule", "storageControllerNextConsistencyCheckSchedule", "consistency-check", VersionMeta.Version313h, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'storageController'], [], [None])
    }
    ...
    prop_meta = {
        ...
        "modular": {
            "cc_schedule_mode": MoPropertyMeta("cc_schedule_mode", "ccScheduleMode", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "cc_state": MoPropertyMeta("cc_state", "ccState", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            ...
            "exec_frequency": MoPropertyMeta("exec_frequency", "execFrequency", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "id": MoPropertyMeta("id", "id", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
            "next_exec_time": MoPropertyMeta("next_exec_time", "nextExecTime", "string", VersionMeta.Version313h, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
