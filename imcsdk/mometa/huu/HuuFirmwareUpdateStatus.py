...
class HuuFirmwareUpdateStatus(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("HuuFirmwareUpdateStatus", "huuFirmwareUpdateStatus", "updateStatus", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'huuFirmwareUpdater'], [u'huuUpdateComponentStatus'], [None])
    }
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "overall_status": MoPropertyMeta("overall_status", "overallStatus", "string", VersionMeta.Version151f, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
        ...
        "modular": {
            ...
            "overall_status": MoPropertyMeta("overall_status", "overallStatus", "string", VersionMeta.Version2013e, MoPropertyMeta.READ_ONLY, None, 0, 510, None, [], []), 
