...
class GenerateCertificateSigningRequest(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "subject_alt_name_type1": MoPropertyMeta("subject_alt_name_type1", "subjectAltNameType1", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x100000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type10": MoPropertyMeta("subject_alt_name_type10", "subjectAltNameType10", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x200000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type2": MoPropertyMeta("subject_alt_name_type2", "subjectAltNameType2", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x400000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type3": MoPropertyMeta("subject_alt_name_type3", "subjectAltNameType3", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x800000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type4": MoPropertyMeta("subject_alt_name_type4", "subjectAltNameType4", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x1000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type5": MoPropertyMeta("subject_alt_name_type5", "subjectAltNameType5", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x2000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type6": MoPropertyMeta("subject_alt_name_type6", "subjectAltNameType6", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x4000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type7": MoPropertyMeta("subject_alt_name_type7", "subjectAltNameType7", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x8000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type8": MoPropertyMeta("subject_alt_name_type8", "subjectAltNameType8", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x10000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_type9": MoPropertyMeta("subject_alt_name_type9", "subjectAltNameType9", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x20000000, 0, 10, None, ["DNS", "EMAIL", "IP", "URI", "dns", "email", "ip", "uri"], []), 
            "subject_alt_name_value1": MoPropertyMeta("subject_alt_name_value1", "subjectAltNameValue1", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x40000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value10": MoPropertyMeta("subject_alt_name_value10", "subjectAltNameValue10", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x80000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value2": MoPropertyMeta("subject_alt_name_value2", "subjectAltNameValue2", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x100000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value3": MoPropertyMeta("subject_alt_name_value3", "subjectAltNameValue3", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x200000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value4": MoPropertyMeta("subject_alt_name_value4", "subjectAltNameValue4", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x400000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value5": MoPropertyMeta("subject_alt_name_value5", "subjectAltNameValue5", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x800000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value6": MoPropertyMeta("subject_alt_name_value6", "subjectAltNameValue6", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x1000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value7": MoPropertyMeta("subject_alt_name_value7", "subjectAltNameValue7", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x2000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value8": MoPropertyMeta("subject_alt_name_value8", "subjectAltNameValue8", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x4000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
            "subject_alt_name_value9": MoPropertyMeta("subject_alt_name_value9", "subjectAltNameValue9", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x8000000000, 0, 128, r"""[^""#]{0,128}""", [], []), 
        ...
        "modular": {
            "add_challenge_password": MoPropertyMeta("add_challenge_password", "addChallengePassword", "string", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x2, None, None, None, ["No", "Yes", "no", "yes"], []), 
            "challenge_password": MoPropertyMeta("challenge_password", "challengePassword", "string", VersionMeta.Version401a, MoPropertyMeta.READ_WRITE, 0x4, 0, 20, r"""[^""#]{0,20}""", [], []), 
