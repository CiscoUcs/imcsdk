...
class AdaptorGenProfile(ManagedObject):
    ...
    prop_meta = {
        ...
        "classic": {
            ...
            "port_channel_enable": MoPropertyMeta("port_channel_enable", "portChannelEnable", "string", VersionMeta.Version313a, MoPropertyMeta.READ_WRITE, 0x10, None, None, None, ["Disabled", "Enabled", "disabled", "enabled"], []), 
            ...
            "port_channel_capable": MoPropertyMeta("port_channel_capable", "portChannelCapable", "string", VersionMeta.Version313a, MoPropertyMeta.READ_ONLY, None, None, None, None, [], []), 
