...
class AdaptorFcRecvQueueProfile(ManagedObject):
    ...
    mo_meta = {
        ...
        "modular": MoMeta("AdaptorFcRecvQueueProfile", "adaptorFcRecvQueueProfile", "fc-rcv-q", VersionMeta.Version2013e, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], [u'adaptorHostFcIf'], [], [None])
    }
