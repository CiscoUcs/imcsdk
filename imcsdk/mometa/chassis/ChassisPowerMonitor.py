...
class ChassisPowerMonitor(ManagedObject):
    ...
    mo_meta = {
        "modular": MoMeta("ChassisPowerMonitor", "chassisPowerMonitor", "pwrmonitor", VersionMeta.Version2013e, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], [u'equipmentChassis'], [], [None])
    }
